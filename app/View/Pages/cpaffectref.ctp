...
<div id="menu">
	...
	<a title="Affecter un référent à un allocataire" href="affectref">Affecter un référent</a> > <i>Cas pratique&nbsp;:Affectation d'un référent en masse</i>
		<h2>Affecter un référent</h2>
		<p><i>Cas pratique &nbsp;: Comment remplacer un référent&nbsp;?</i></p>
<p>Procédure pour réaffecter les dossiers d’un référent sortant de la structure.<br/>
A partir de ce filtre, sélectionner le nom du référent sortant dans la liste  &nbsp;:
</p>
<img src="/didac/images/remplaceref.jpg" alt="Remplacer un référent" width="605px" height="206px" />
<p>Cliquer en bas sur le bouton "Rechercher" <img class="bimg" src="/didac/images/bval.jpg" alt="Bouton Formulaire" width="99px" height="29px" />  pour obtenir la liste des bénéficiaires affectés à ce référent.</p>
