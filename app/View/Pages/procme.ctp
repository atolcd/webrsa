...
<li>Une fois passées en EP les réorientations sont validées sur le logiciel, un courrier de notification au bénéficiaire est généré avec les coordonnées du nouveau service référent à contacter </li>
<li>Remarque : depuis février 2016 les réorientations sont validées immédiatement après le passage en l’EP (en général l’après-midi-même), sans attendre l’arbitrage final sur les sanctions, afin de réduire la durée de traitement global de ces demandes </li>
</ul>
</p>
<p><b>Règle relative aux contrats dans le cadre des réorientations&nbsp; : </b>
<ul><li>Lorsque les réorientations sont validées dans WEBRSA, il est mis fin automatiquement aux éventuels contrats en cours (la date de fin de contrat est la date de la validation de la réorientation). Le bénéficiaire devra réaliser un nouveau contrat avec le service référent qui lui a été désigné par le Conseil départemental. </li>
<li>Par conséquent, tant que la réorientation n’a pas été actée, il est préférable de ne pas faire de contrat et de prévoir la saisie d’un contrat après la date de l’EP. </li>
</ul></p>
