...
<br/>	
<ol start="7"><li><a name="modacc"></a>Le module accompagnement</li></ol>
<p>Dans le dossier, le module accompagnement est représenté par le lien "Synthèse du suivi" (Accompagnement du parcours). Il vous permet de visualiser toutes les informations du parcours du bénéficiaire et de les modifier.</p>
<img src="/didac/images/liacc.jpg" alt="Le module accompagnement" width="206px" height="83px" />

<p>La synthèse de suivi est constituée de 3 onglets : Accompagnement, Courriers et Fichiers liés.</p>
<img src="/didac/images/ongacc.jpg" alt="Le module accompagnement" width="402px" height="170px" />
<ul><li type="A"><u>L'onglet "Accompagnement" </u></li>
<p>Dans cet onglet, vous avez accès aux informations des droits, compétences, suivi et actions.</br>
Toute l'activité du suivi y figure dans la partie "Actions". Les actions peuvent être filtrées par thématique et par date. </p>
<img src="/didac/images/acc.jpg" alt="Le module accompagnement" width="690px" height="437px" />
<p>Le filtre par date est disponible dans tous les onglets.</p>
<img src="/didac/images/accfidate.jpg" alt="Le module accompagnement" width="690px" height="129px" />
<p>Cocher la case "Filtrer par date" pour activer les listes de dates.</p>
<p>Utiliser la liste des actions pour filtrer par thématique.</p>
<img src="/didac/images/accaction.jpg" alt="Le module accompagnement" width="690px" height="135px" />
<li type="A"><u>L'onglet "Courriers" </u></li>
<p>L'onglet "courrier" recense tous les courriers générés par WebRsa.</p>
<img src="/didac/images/ongcour.jpg" alt="Le module accompagnement" width="690px" height="257px" />
<p>Les courriers peuvent tous être réimprimés en cliquant sur le lien "Imprimer".</br>
Le lien "Liste" vous amène sur la partie du dossier concernant l'action.</p>
<li type="A"><u>L'onglet "Fichiers liés" </u></li></ul>
<p>Cet onglet vous permet d'avoir la liste des documents déposés sur la partie "Rendez-vous".</p>
<img src="/didac/images/accfili.jpg" alt="Le module accompagnement" width="690px" height="111px" />
<p><u>Sur le module accompagnement </u></br></br></br>
Vous avez la possibilité de filtrer les fichiers par date en cochant la case "Filtrer par date" afin d'activer les listes de date.
Tous les fichiers liés déposés sur les rendez-vous sont visibles sur cette partie du module.</p>
<img src="/didac/images/fili.jpg" alt="Le module accompagnement" width="690px" height="146px" />
<p>Les fichiers peuvent être visualisés en cliquant sur le lien "Voir", ou téléchargés sur le lien "Télécharger".</p>
<p>Le lien "Liste" vous amène sur les fichiers liés du module sur lequel ils ont été ajoutés, en l'occurrence les RDV.</p>
<img src="/didac/images/filirdv.jpg" alt="Le module accompagnement" width="690px" height="336px" />

<p>NB : Tous les liens du module s'ouvrent dans un nouvel onglet.</p>
