...
<ol start="2"><li><a name="mcer">Depuis le menu CER</a></li></ol>
<img src="/didac/images/rdvcer.jpg" alt="Depuis le menu CER" width="534px" height="172px" />
<p>La liste des bénéficiaires n'ayant plus de CER en cours de validité s'affiche directement  &nbsp;:</p>
<img src="/didac/images/rdvlcer.jpg" alt="liste menu CER" width="605px" height="210px" />
<p>Lorsqu'on clique sur le lien <u>Prendre RDV</u>, on a un nouvel onglet qui s'ouvre &nbsp;:</p>
<img src="/didac/images/ongletrdv.jpg" alt="liste menu CER" width="538px" height="40px" />
<p>Après la validation du rendez-vous, il vous est donc possible de revenir sur la liste "Saisie d'un CER" en se positionnant sur l'onglet resté actif.
<br/><br/>
En cliquant sur le lien de la prise de <b>Rendez-vous</b>, on arrive sur le dossier du bénéficiaire &nbsp;: Cliquer sur le lien Gestion RDV, puis renseignez le formulaire comme précédemment.
</p>
<br/><br/>
