...
<ol start="4"><li><a name="separe"></a>Cas des couples séparés</li></ol>
<p>Lorsqu'un couple se sépare, le conjoint sortant perd son "rôle" de conjoint (CJT). <br/>

Dans le cas où le conjoint sortant fait sa propre demande de RSA avec un nouveau N° de CAF, les informations de son ancien dossier sont consultables à partir de son nouveau dossier.
<br/>
<u>Sur la synthèse du (nouveau) dossier </u><br/>
</p>

<img src="/didac/images/doshis.jpg" alt="Historique du dossier" width="368px" height="152px" />

<div style="position:relative; display:block; float:right; right:30px;width:295px; top:80px;">
<p>Le lien "Voir" vous permet d'accéder à l'ancien dossier et de visualiser le suivi de ce Brsa.</p></div><br/>
<u>A l'intérieur du (nouveau) dossier, et dans chaque rubrique ayant trait à votre activité</u>

<img src="/didac/images/enrdhis.jpg" alt="Historique du dossier" width="605px" height="72px" />

<p>Ci-dessous : Informations sur les CER figurants sur l'ancien dossier</p>

<img src="/didac/images/dhcer.jpg" alt="Historique du dossier" width="606px" height="334px" />


<p>Lorsqu'on clique sur le lien "Voir" (ici sur les CER), on consulte les dossiers du conjoint pour lequel ce Bénéficiaire apparaît sans prestation :</p>
...
<li>CER</li>
<li>Orientations</li>
<li>Personne chargée du suivi </li>
<li>Rendez-vous</li>
<li>D1</li>
<li>D2</li>
<li>Fiche de prescription</li>
</ul>
</p>
