...
<div id="menu">
	...
	<a style="text-align:right;padding-right:15px;float:right;" href="javascript:history.forward(+1)">Page suivante&nbsp;&rsaquo;&rsaquo;</a>
		<h2>Les statistiques&nbsp;:&nbsp;<i>Les tableaux B5</i></h2>
<div class="nav">
...
<ol start="4"><li><a name="prsp">Prescription à caractère sociaux professionnel B5</a></li></ol>

<img src="/didac/images/spsp.jpg" alt="Prescription à caractère sociaux professionnelle" width="430px" height="421px" />
<img src="/didac/images/spsps.jpg" alt="Prescription à caractère sociaux professionnelle" width="643px" height="73px" />

<p>
Les listes déroulantes vous permettent de sélectionner :
<ul><li>L'année</li>
<li>Votre structure (par défaut, il s'agira toujours de votre structure).</li>
<li>Le type d'action : PDI ou Hors PDI</li></ul></p>


<p class="nb"><b>B5 : Prescription sur les actions à caractère socio-professionnel et professionnel</b></p>
<img src="/didac/images/nbb5.jpg" alt="Les tableaux B5" width="414px" height="53px" />
<p>Nombre de personnes différentes bénéficiant d'une prescription => Au minimum, la fiche doit être signée.<br/>Nombre de personnes différentes ayant participé à une action => Bloc "Suivi de l'action", l'allocataire a intégré l'action : Oui.<br/>Résultat des actions prescriptes comptabilisées</p>
<img src="/didac/images/b5.jpg" alt="Les tableaux B5" width="643px" height="250px" />
<img src="/didac/images/nbmb5.jpg" alt="Les tableaux B5" width="350px" height="67px" />

<p><u>Nombre de bénéficiaires qui ne se sont pas déplacés</u>&nbsp; :(Bloc "Effectivité de la prescription")&nbsp;: <br/>La personne s'est présentée : Non ou Excusé.<br/>
<u>Nombre de fiches de prescription en attente d'un retour</u>&nbsp;:<br/>Sont comptabilisées les fiches de prescription : (Bloc "Effectivité de la prescription"):
Des bénéficiaires présents à l’action ou des bénéficiaires sans information sur leur présence.</p>

<img src="/didac/images/b5fp.jpg" alt="Les tableaux B5" width="228px" height="513px" />


<p><u>Prescription du PDI</u></p>
<img src="/didac/images/b5pdi.jpg" alt="Les tableaux B5" width="603px" height="149px" />

<p><u>Prescription hors PDI</u></p>
<img src="/didac/images/b5hpdi.jpg" alt="Les tableaux B5" width="608px" height="155px" />
<p><u>Résultat pour votre commune</u> &nbsp;:</p>
<img src="/didac/images/rsp.jpg" alt="résultats B5" width="643px" height="317px" />
<br/>
<p>En bas de chaque tableaux, vous pouvez conserver l'historique vos tableaux à un instant i en cliquant sur le bouton "Historiser"&nbsp;<img class="bimg" width="105px" height="33px" alt="Le bouton Historiser" src="/didac/images/bhi.jpg">  .</p>
