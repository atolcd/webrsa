...
<div id="menu">
	...
	<a title="Aller à la page suivante" style="text-align:right;padding-right:15px;float:right;" href="javascript:history.forward(+1)">Page suivante&nbsp;&rsaquo;&rsaquo;</a>
		<h2>Les Recherches&nbsp;:&nbsp;<i>Par DSP</i></h2>
<div class="nav">
...
<img style="position:relative;float:right;right:192px;top:-158px;" src="/didac/images/rechdsp.jpg" alt="Les recherches par DSP" width="168px" height="257px" /><div style="margin-top:85px;"></div>
<ol start="5"><li style="margin-top:25px;"><a name="dsp">Recherche par DSPs</a></li></ol>
<p>Les filtres correspondants aux "problématiques" des bénéficiaires du RSA sont à présent disponibles&nbsp;:<br/>
Le cadre des données socio professionnelles permet de&nbsp;:</p>
<ul><li>Filtrer sur les difficultés sociales</li>
<li>Filtrer sur le domaine de l'accompagnement individuel</li>
<li>Filtrer sur les obstacles à la recherche d'emploi</li></ul>
<p>Les difficultés sociales apparaissent dans la liste déroulante.</p>
<img src="/didac/images/diffsoc.jpg" alt="Recherche par DSP" width="690px" height="169px" />
<p>Les thèmes de l'accompagnement individuel apparaissent dans la liste déroulante.</p>
<img src="/didac/images/dspacc.jpg" alt="Recherche par DSP" width="690px" height="111px" />
<p>Les obstacles à la recherche d'emploi.</p>
<img src="/didac/images/obsemploi.jpg" alt="Recherche par DSP" width="690px" height="108px" />
<p>La recherche par DSP vous permet de consulter la liste des dossiers pour lesquels une DSP a été enregistrée.</p>
<br/>
<p>Le formulaire de recherche par DSP vous permet de consulter la liste des dossiers pour lesquels une DSP a été enregistrée.<br/>Le formulaire de recherche par DSP propose les critères de recherches communs  &nbsp;: recherche par dossier, par prestation, par état du dossier, par date de demande RSA, par adresse… et d’autres critères de recherche spécifiques à la DSP.</p>

<p><u>Recherche selon la situation professionnelle</u></p>
<img src="/didac/images/rspdsp.jpg" alt="Recherche par DSP" width="605px" height="133px" />

<p>Les recherches sur la <u>dernière activité</u> et <u>l'emploi recherché</u> utilisent les codes ROME v3, comme lors de la saisie de la DSP.</p>
<img src="/didac/images/rechdsprome.jpg" alt="Recherche par DSP" width="605px" height="98px" />
<ul><li>Recherche rapide</li>
<li>Code famille </li>
<li>Code domaine </li>
<li>Code métier</li> 
<li>Appellation métier</li></ul>
<p>ll existe <u>2 méthodes de recherche</u> des métiers par Code ROME :

<ul><b><li>La Recherche rapide en saisissant le nom du métier</li></b></ul>

La zone de texte "<b>Recherche Rapide</b>" est une aide à la recherche et à la saisie rapide d’un métier. Saisissez le nom du métier, le système vous proposera une liste de métiers. Une fois le métier sélectionné, les champs code famille, code domaine, code métier et appellation métier se remplissent automatiquement.
</p>
<img src="/didac/images/rechrapdsprom.jpg" alt="Recherche par DSP" width="606px" height="93px" />
<ul><b><li>A partir des listes déroulantes (Famille, domaine, métier, appellation métier) </li></b></ul>
<p>Les listes <b>famille, domaine, métier, appellation métier</b> sont interdépendantes.
Il faut tout d’abord commencer par la saisie du code famille jusqu’à finir par l’appellation métier.<br/>

Pour le code famille, la liste est la suivante :
</p>
<img src="/didac/images/rechcfromdsp.jpg" alt="Recherche par DSP" width="605px" height="166px" />
<p>Pour le code domaine, la liste est la suivante :</p>
<img src="/didac/images/rechromdspcod.jpg" alt="Recherche par DSP" width="605px" height="136px" />
<p>Les anciennes zones de saisie libre pour retrouver les emplois recherchés sont toujours disponibles</p>
<img src="/didac/images/rechdspme.jpg" alt="Recherche par DSP" width="587px" height="71px" />
<br/>
<br/>
