...
<p><a href="fp">La Fiche de prescription</a>&nbsp;<em>Cas pratique  &nbsp;: Comment renseigner le suivi lorsqu'un Brsa quitte la formation qu'il a commencée?</em></p>
<h2>La fiche de prescription</h2>
<p>Dans le champ du suivi de l'action,<br/>

A la question l'allocataire a intégré l'action, répondez "<b><i>Non</i></b>" pour avoir accès aux items de la liste déroulante.
Sur la ligne du motif, sélectionnez "<b><i>Abandon</i></b>".
</p>
<img src="/didac/images/fpabandon.jpg" alt="Le prescripteur" width="516px" height="200px" />
<br/>
