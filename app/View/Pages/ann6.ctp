...
<head>
	...
	<ul>	
		...
		<li id="activation"><a title="Annexe 6: L'enregistrement de la structure de parcours " href="ann6">La structure de parcours</a></li>
	...
	<a style="text-align:right;padding-right:15px;float:right;" href="javascript:history.forward(+1)">Page suivante&nbsp;&rsaquo;&rsaquo;</a>
		<h2>Annexe6&nbsp;:&nbsp;L'enregistrement de la structure de parcours</h2>
		
<p>Nous vous rappelons deux règles importantes à respecter dés que vous travaillez sur un dossier sur WEB RSA&nbsp; : </p>

<ol style="font-weight:normal;"><li>Vous devez vous enregistrer comme référent de parcours dés que vous accompagnez un allocataire (p .24 et 32. du guide).</li><p> Si vous omettez cette étape, l’écran de recherche par « référent de parcours » ne rapportera pas tous vos suivis.</p>

<li>Pour tout rendez vous (individuel ou collectif) entre l’allocataire et votre structure, vous devez vous enregistrer comme structure et personne établissant le rendez vous. </li>
</ol>
<p>Ces informations sont proposées par défaut si vous êtes structure référente. </p>
<p>Si tel n’est pas le cas, vous devez modifier ce qui est proposé et vous enregistrer. 
<br/>(P 44 du guide).</p>
<p>Ceci est indispensable pour que vos tableaux de bord rendent compte de l’exhaustivité de votre activité.</p>
