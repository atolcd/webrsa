...
<ul>
<li>Le référent et l’allocataire consultent les actions d’insertion et de  formations.</li>
<li>Le référent contacte l’organisme de formation ou d’insertion pour vérifier la disponibilité des places avec possibilité de prise de rendez-vous avec le bénéficiaire.</li>
<li>Le référent enregistre une fiche de prescription &nbsp;: renseignement de la  partie &quot;Prescripteur&quot;, &quot;Allocataire&quot;, &quot;Prestataire&quot;.</li>
<li>Le référent et l’allocataire signent la fiche.</li>
...
<p><u>Les actions prescrites peuvent être de 2 types :</u><br/></p><p> PDI => Un numéro de convention est disponible depuis le catalogue : La saisie (ou Ctrl+C / Ctrl+V depuis le catalogue des actions sur le site) de ce numéro de convention renseigne automatiquement les champs qui suivent:</p>
<ul><li>Thématique</li>
<li>Catégorie</li>
<li>Filière</li>
...
<li>Intitulé</li>
<li>L'adresse</li>
<li>La durée de l'action</li></ul><p>Les dates de début ainsi que les dates de fin de l'action peuvent être renseignées si vous les connaissez.<br/>Hors PDI => Ces actions n'ont pas de numéro de convention. Il vous appartient de renseigner les champs. &nbsp;
</p><ul><li>Thématique</li>
<li>Catégorie</li>
<li>Filière</li>
<li>Nom du prestataire</li>
<li>Intitulé</li>
<li>L'adresse</li>
<li>La durée de l'action</li></ul>

<p><u>Les actions "En attente" de conventionnement.</u></p>
<p>Lorsque les N° de convention ne sont pas disponibles, les actions sont "En attente".</p>
<ul>
...
<li>Les actions dont le numéro de convention commence par <span style="color:red;">NFT</span>93…=> <span style="color:red;"><u>N</u></span>uméro <span style="color:red;"><u>F</u></span>ictif <span style="color:red;"><u>T</u></span>acite…<br/>
Les numéros de conventions de ces actions sont mises à jour automatiquement.
Aucune action de mise à jour de la part de l’utilisateur n'est requise.</li></ul>
