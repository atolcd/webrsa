...
<div id="menu">
	...
	<a title="Faire des requêtes" href="recherches">Les Recherches</a> > <i>Cas pratique&nbsp;:Retrouver nos rendez-vous.</i>
		<h2>Les Recherches</h2>
		
	<p>Depuis le menu Recherches / Par rendez-vous.</p>	
<!--Cas rdv &nbsp;: Consulter les rendez-vous du jour-->
<p><i>Cas pratique  &nbsp;: Comment visualiser mes rendez-vous du jour&nbsp;?</i><br/>
Prenons l'exemple d'un Chargé d'insertion qui souhaite consulter ses rendez-vous du jour  &nbsp;:</p>
...
<p><u>Résultats &nbsp;:</u></p>
<img src="/didac/images/cpresrdvj.jpg" alt="Rendez-vous du jour CI" width="671px" height="144px" />
