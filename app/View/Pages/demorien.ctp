...
<div id="menu">
	...
	<ul>	
		...
		<li  id="activation"><a href="demorien">La demande de réorientation</a></li>
...
<img src="/didac/images/fbdor.jpg" alt="Accéder à la demande de réorientation" width="605px" height="153px" />
<p>Renseigner le formulaire puis enregistrer la demande.<br/>Les champs marqués d'un astérisque (<span style="color &nbsp;:red">*</span>) sont à renseigner obligatoirement.</p>
<img src="/didac/images/formor.jpg" alt="Formulaire de demande de réorientation" width="605px" height="565px" />
<ul>
<li>Certaines informations sont rapatriées automatiquement  &nbsp;:
<ul>
<li>Si la personne est soumise à droits et devoirs.</li>
<li>Le rang d'orientation est visible sur le formulaire.</li>
</ul>
</li>
</ul>
<p>Toute demande de réorientation fait l’objet d’un <b><u>passage en Equipe Pluridisciplinaire</u>&nbsp;( EP )</b>.<br/>Après la validation de la demande de réorientation, il est indiqué qu’il est impossible d’ajouter une nouvelle réorientation et que la réorientation enregistrée fait l’objet d’un passage en Equipe Pluridisciplinaire.</p>
<img src="/didac/images/orep.jpg" alt="Orientation EP" width="605px" height="285px" />
