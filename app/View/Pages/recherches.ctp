...
<p>Sur&nbsp; <b><i><u>tous</u></i></b>&nbsp; les écrans de recherche.</p>
<ul>
<li><pre>Le comptage des résultats est disponible, ce qui vous permet de visualiser vos totaux.</pre></li>
<li>Un filtre sur la structure de suivi.</li>
</ul>
...
<p>Le référent du suivi est également visible sur le dossier<img class="bimg" src="/didac/images/accparcou.jpg" alt="Accompagnement du parcours" width="169px" height="60px" />   en cliquant sur le lien "Référent du parcours".</p>
<img src="/didac/images/refparc3.jpg" alt="Référent du parcours" width="690px" height="89px" />

<p>Un filtre sur la structure du parcours est disponible : Il s'agit de la structure d'accompagnement. Ce nouveau filtre vous permet de récupérer tous vos suivis quelque soit l'orientation CG.</p>
...
<p>Le bouton télécharger le tableau permet d'exporter les données au format Excel&nbsp;:</p>
<img src="/didac/images/teltab.jpg" alt="Télécharger le tableau" width="177px" height="41px" />
<p><u>Téléchargement des informations exportées</u>&nbsp:<br/>
<p>
Date de demande, NIR, Etat du droit, Nom/Prénom allocataire, Date de naissance, Adresse/Commune de l'allocataire, Type d'orientation, Identifiant Pôle Emploi, N° CAF, Référent, Sexe, conditions de logement.
</p>
