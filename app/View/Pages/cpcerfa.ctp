...
<!--Cas file active-->
<p><em>Cas pratique  &nbsp;: Comment retrouver les CER en cours de validité&nbsp; : 
Les CER Validés CG ?

?</em></p>
<p><b>Ce filtre vous permet de récupérer votre <i>file active</i>&nbsp; :</b></p>
...
<ul>
<li>Sélectionner votre structure dans la liste.</li>
<li>Sélectionner ensuite votre nom dans la liste (les listes des noms de référents sont interdépendantes).</li>
</ul>
<img src="/didac/images/cpcer.jpg" alt="Recherche par CER" width="604px" height="40px" />
<p>Valider votre recherche en cliquant sur "Rechercher".</p>
<p><u>Résultats&nbsp;:</u></p>
...
<p><b><i>Structure référente</i></b>&nbsp; :&nbsp;  Il s'agit de la structure d'orientation faite par le CG.</p>
<img src="/didac/images/cpstref.jpg" alt="Recherche par CER" width="690px" height="47px" />
