...
<ul style="list-style-type:none"><li>2.3.&nbsp;Hors PDI</li></ul>

<p>Les actions Hors PDI n'ont pas de code de conventionnement du département.
Sélectionner la thématique de l'action "Hors PDI".</p>

<img src="/didac/images/fphpdith.jpg" alt="Actions Hors PDI" width="630px" height="184px" />
<p>Prescription emploi, professionnelle, sociale, socioprofessionnelle ou vers les acteurs de la santé : Les champs catégorie, filière, intitulé, et prestataire sont à renseigner après avoir sélectionné la thématique.</p>


<img src="/didac/images/fpcathpdi.jpg" alt="Actions Hors PDI" width="605px" height="219px" />

<p>Certaines actions du Hors PDI peuvent être dispensées par des partenaires / prestataires du PDI. Auquel cas, les adresses de ces actions seront disponibles dans WebRSA.
<br/>
Lorsque vous renseignez le prestataire, une aide à la saisie vous est proposée;
</p>
<img src="/didac/images/fpprshpdi.jpg" alt="Actions Hors PDI" width="549px" height="97px" />

<p>Lorsqu'on clique sur le lien, l'adresse de l'organisme est renseignée automatiquement.</p>
<img src="/didac/images/fpadrhpdi.jpg" alt="Actions Hors PDI" width="626px" height="198px" />

<p>Les adresses des actions hors PDI peuvent être présentes selon 2 cas de figure :</p>
<img src="/didac/images/fp2cashpdi.jpg" alt="Actions Hors PDI" width="650px" height="123px" />

<p>Lorsque l'adresse n'est pas présente, vous pouvez renseigner un champ de saisie libre.</p>
<img src="/didac/images/fpadman.jpg" alt="Actions Hors PDI" width="652px" height="165px" />

<p>Vous pouvez renseigner le numéro de téléphone, l'adresse mail ainsi que le numéro de FAX.</p>
<img src="/didac/images/fpfax.jpg" alt="Actions Hors PDI" width="471px" height="84px" />


<p>Renseigner les dates de début et de fin de l'action, si vous les connaissez; renseigner la durée de l'action (manuellement).</p>
<img src="/didac/images/fpduree.jpg" alt="Actions Hors PDI" width="630px" height="96px" />

<p>Si le bénéficiaire doit se munir de certains papiers, vous pouvez cocher les cases correspondantes, ou renseigner le champ "Autre".</p>
<img src="/didac/images/fpautre.jpg" alt="Actions Hors PDI" width="674px" height="262px" />

<p>Renseigner le champ "Engagement" : Dérouler les listes de dates pour enregistrer la date de signature de la fiche avec l'allocataire.</p>
<img src="/didac/images/fpengage.jpg" alt="Actions Hors PDI" width="605px" height="60px" />

<p>Le statut de la fiche est alors à l'étape <b><i>"Signée"</i></b>.<br/>

<u>Remarque</u>: Avant la signature, le statut de la fiche = <i>Renseignée</i>.
Si le champ signé est renseigné alors le statut de la fiche = <i>Signée</i>.</p>

<img src="/didac/images/fpsig.jpg" alt="Actions Hors PDI" width="605px" height="29px" />
<img src="/didac/images/fprens.jpg" alt="Actions Hors PDI" width="605px" height="115px" />

<p>Avant de remettre la fiche au partenaire, il faut qu'elle soit "Signée" par le bénéficiaire.<br/><br/>Renseigner les modalités ainsi que la date de transmission de la fiche.</p>
<img src="/didac/images/fpmod.jpg" alt="Actions Hors PDI" width="605px" height="190px" />
<p>Valider la fiche de prescription en bas du formulaire, en cliquant sur le bouton "Valider".</p>

<img src="/didac/images/fpval.jpg" alt="Actions Hors PDI" width="156px" height="44px" />

<p>Le statut de la fiche est alors à l'étape <b><i>"Transmise partenaire"</i></b>&nbsp; : Parce que l'une des cases du champ des modalités de transmission a été cochée.</p>
