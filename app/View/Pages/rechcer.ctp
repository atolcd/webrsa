...
<div id="menu">
	...
	<a title="Aller à la page suivante" style="text-align:right;padding-right:15px;float:right;" href="javascript:history.forward(+1)">Page suivante&nbsp;&rsaquo;&rsaquo;</a>
		<h2>Les Recherches&nbsp;:&nbsp;<i>Par CER</i></h2>
<div class="nav">
...
<img style="position:relative;float:right;right:192px;top:-158px;" src="/didac/images/rechcer.jpg" alt="Les recherches par CER" width="164px" height="260px" />
<div style="margin-top:85px;"></div>
<ol start="4"><li style="margin-top:25px;"><a name="cer">La recherche par contrat (CER)</a></li></ol>
<p>La recherche par contrat vous permet de consulter la liste des CER selon des critères choisis.<br/>Le formulaire de recherche &quot;par contrat&quot; propose les critères de recherches communs  &nbsp;: recherche par dossier, par prestation, par état du dossier, par date de demande RSA et d’autres critères de recherche spécifiques au contrat.</p>
<img src="/didac/images/mcer.jpg" alt="Recherche par CER" width="537px" height="260px" />
<p><u>Recherche par CER</u></p>
<p>Les critères de recherches communs&nbsp;:</p>
<img src="/didac/images/rcer.jpg" alt="Recherche par CER" width="700px" height="682px" />
<p>Les critères de recherche propres aux contrats&nbsp;:</p>
<img src="/didac/images/rcer2.jpg" alt="Recherche par CER" width="700px" height="686px" />

<p><u>Allocataire dont le CER est arrivé à échéance</u>&nbsp; :<br/>
Il s'agit des contrats n'étant plus en cours de validité.</p>
<img src="/didac/images/cerech.jpg" alt="Recherche par CER" width="298px" height="34px" />
<p><u>Résultats</u>&nbsp;:<br/>
...
<img src="/didac/images/nbcer.jpg" alt="Recherche par CER" width="372px" height="66px" />
<p>Si on coche la case "Obtenir le nombre total de résultats", le total s'affiche au dessus de la liste de résultats.</p>
<img src="/didac/images/affnbcer.jpg" alt="Recherche par CER" width="606px" height="71px" />
<p><u>Par CER se terminant bientôt (arrivant à échéance)&nbsp;:</u>.<br/>Il s'agit des contrats qui vont se terminer entre la date du jour +1 mois.</p>
<p>Il suffit de cocher cette case pour consulter les dossiers qui ne seront plus valides dans le mois qui suit le jour de la requête.</p>
<img src="/didac/images/cerfin.jpg" alt="Recherche par CER" width="297px" height="33px" />
<br/>
<p><u>Résultat</u>&nbsp;:</p>
<img src="/didac/images/rescerfin.jpg" alt="Recherche par CER" width="606px" height="237px" />
<ul><li>Cette liste permet de visualiser les CER qui vont arriver à échéance à partir de la date du jour de la requête sur une durée de 1 mois.</li></ul>
<p>Si on demande le "nombre total de résultats", on a directement le volume de contrats qui vont bientôt arrivés à échéance.</p>
<a class="haut" href="#haut">Haut de la page</a>
<br/>

<img src="/didac/images/durcer.jpg" alt="Recherche par CER" width="690px" height="155px" />
<p>Par exemple si je souhaite visualiser mes CER d'une durée de 9 mois et qui ont été saisis sur l'année écoulée jusqu'à aujourd'hui :</p>
<img src="/didac/images/datedurcer.jpg" alt="Recherche par CER" width="605px" height="92px" />
<p><u>Résultats</u>&nbsp;:</p>
<img src="/didac/images/resdurcer.jpg" alt="Recherche par CER" width="606px" height="238px" />
<br/>


<p>"Structure référente" correspond à la structure qui a établi le CER.</p>
<img src="/didac/images/nbcerstr.jpg" alt="Recherche par CER" width="695px" height="410px" />
<p><u>Résultats</u>&nbsp;:</p>
<img src="/didac/images/resnbcerstr.jpg" alt="Recherche par CER" width="695px" height="286px" />
<br/>
