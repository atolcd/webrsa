...
<!-- Effectivité -->
<ol start="4"><li >Renseigner l'effectivité de la prescription</li>

<p>Cette partie est à renseigner après la rencontre entre l’allocataire et l’organisme.<br/>Afin de renseigner l'effectivité de la prescription, cliquer sur le lien "Modifier".</p>
	<img src="/didac/images/effectfp.jpg" alt="Effectivité de la Prescription" width="605px" height="108px" />
<p>Renseigner le groupe "effectivité de la prescription"&nbsp;:<br/>Renseigner les dates de retour, et si la personne s'est présentée Oui / Non.</p>
<img src="/didac/images/fpdretour.jpg" alt="Catégorie d'action Fiche de Prescription" width="675px" height="164px" />
<p>Si la personne ne s'est pas présentée (items "Non", ou "S'est excusée"), le champ de date "...à laquelle la personne s'est présentée" n'est pas disponible.</p>	
<img src="/didac/images/fpabs.jpg" alt="Catégorie d'action Fiche de Prescription" width="675px" height="140px" />	
	<p style="bimg">Valider en bas du formulaire.<img  width="156px" height="44px" alt="Actions Hors PDI" src="/didac/images/fpval.jpg"></p>
	
<p>Le statut de la fiche devient alors <b><i>"Effectivité renseignée"</i></b>.</p>	
<img src="/didac/images/fpeffectiv.jpg" alt=" Effectivité Fiche de Prescription" width="605px" height="108px" />	
<p><u>Remarque</u>: Si les champs sont renseignés alors le statut de la fiche= Effectivité renseignée.
Une fiche avec la réponse <span style="color:red">Ne s'est pas présenté"</span> ou <span style="color:red">"Excusé"</span> ne sera pas comptabilisée comme fiche effective.
</p>	
