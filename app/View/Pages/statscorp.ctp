...
<!--<ul><li id="activ"><a title="Remplacer un référent par un autre" href="cpaffectref">Cas pratique &nbsp;: Remplacer en masse un référent</a></li></ul> -->		</li>
	</ul>
		<ul>
	...
	<a style="text-align:right;padding-right:15px;float:right;" href="javascript:history.forward(+1)">Page suivante&nbsp;&rsaquo;&rsaquo;</a>
		<h2>Les statistiques&nbsp;:&nbsp;<i>Télécharger le corpus D2</i></h2>
<div class="nav">
...
<a name="corp"></a><ol><li><a name="">Télécharger le corpus D2</a></li></ol>
<p>Vous pouvez historiser vos recherches sur les tableaux en cliquant sur le bouton "Historiser" en bas de celui-ci :</p>
<img src="/didac/images/bhisd2.jpg" alt="Voir l'historique" width="103px" height="33px" />
<img src="/didac/images/hisd2.jpg" alt="Voir l'historique" width="605px" height="323px" />
<p>Une fois que l'historisation est mémorisée, vous avez accès au bouton "Télécharger le corpus" qui s'active en bas du tableau.</p>
<img src="/didac/images/cd2.jpg" alt="Voir l'historique" width="168px" height="32px" />
<img src="/didac/images/hisd2c.jpg" alt="Voir l'historique" width="605px" height="317px" />
<p>Une fois que vous avez cliqué sur le bouton "Télécharger le corpus", vous pouvez effectuer votre export avec OpenOffice (Ou Excel).</p>
<img src="/didac/images/bresd2.jpg" alt="Voir l'historique" width="168px" height="30px" />
<p>Vous pouvez également "Télécharger le tableau", mais la mise en forme est difficilement lisible (ce tableau est accessible mais nécessite de manipuler la mise en forme sous OpenOffice, pour une meilleure visibilité).</p>
<p>Nous vous proposons donc d'effectuer une" impression" de l'écran en ..../didac//pdf par le menu "Imprimer" de FireFox.</p>
