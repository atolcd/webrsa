...
<div id="menu">
	...
	<a style="text-align:right;padding-right:15px;float:right;" href="javascript:history.forward(+1)">Page suivante&nbsp;&rsaquo;&rsaquo;</a>
		<h2>Les statistiques&nbsp;:&nbsp;<i>Consulter votre historique</i></h2>
<div class="nav">
...
<p>Si je clique sur le lien &quot;Voir&quot;, je visualise mes résultats.<img class="bimg" src="/didac/images/hisvoir.jpg" alt="Voir l'historique" width="52px" height="47px" /></p>
<img src="/didac/images/vuehi.jpg" alt="Voir l'historique" width="480px" height="410px" />
