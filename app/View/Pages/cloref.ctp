...
<a href="affectdos#clorefma">Clôturer un référent</a> <br/>
</div>		
<h2>Le tableau de suivi</h2>
<ol start="5"><li><a name="cde">Clôture des dossiers d’un référent et réaffectation de la file active en masse</a></li></ol>
<p></p>
