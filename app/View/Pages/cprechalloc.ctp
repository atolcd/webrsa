...
<div id="menu">
	...
	<ul><!--ici le sous menu géré avec CSS-->
		...
		<li id="activation"><a title="Naviguer dans le dossier d'un bénéficiaire" href="dossier">Le dossier allocataire&nbsp;+</a><ul>
		<li id="activ"><a title="Rechercher un bénéficiaire du RSA" href="cprechalloc">Cas pratique &nbsp;: Rechercher un dossier</a></li></ul></li>
	</ul>
	<ul>	
	...
	<a title="Naviguer dans le dossier d'un bénéficiaire" href="dossier">Le dossier allocataire</a> > <i>Cas pratique &nbsp;:Comment retrouver un bénéficiaire ?.</i>
		<h2> Le dossier allocataire</h2>



<p>
Il est possible de retrouver un bénéficiaire du RSA en saisissant les premières lettres de son nom suivi d'un astérisque (*)&nbsp;;
le résultat de cette requête sera tous les bénéficiaires dont le nom commence par les lettres saisies.<br/>
Cette technique est très pratique dans le cas où le nom du bénéficiaire serait mal orthographié ou si celui-ci ne connaît pas l'orthographe de son nom par exemple.<br/>
Positionnez vous sur le formulaire de recherche par allocataire.<br/>

Dans le groupe "Recherche par allocataire" et dans le champ "Nom" saisissez les premières lettres de <b><i>son nom suivi d'un astérisque <span style="color:red;">*</span>;</i></b>  
</p>
<img src="/didac/images/rechben.jpg" alt="Rechercher un bénéficiaire" width="606px" height="194px" />

<p>Valider en cliquant sur le bouton "Rechercher" <img class="bimg" src="/didac/images/bval.jpg" alt="Bouton de validation" width="98px" height="29px" />.</p>

<p><u>Résultat</u> &nbsp;:<br/>

La liste des bénéficiaires dont le nom de famille commence par "ben" est rapatriée.</p>
<img src="/didac/images/listerech.jpg" alt="Recherche avec étoile" width="606px" height="243px" />
<p>Parfois d'autres méthodes peuvent servir à retrouver un bénéficiaire &nbsp;:
<ul>
<li>Pour les femmes mariées  Penser à vérifier si son nom est celui d'épouse ou de jeune fille (il existe un champ de recherche par nom de jeune fille).</li>
<li>Faire une recherche par date de naissance.</li>
<li>Utiliser d'autres critères de recherche etc.</li>
<li>Décocher la case "Uniquement la dernière demande pour un même allocataire" (cf FAQ).</li>
</ul>
</p>
<br/>
<br/>
