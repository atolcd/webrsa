...
<head>
	...
	<a style="text-align:right;padding-right:15px;float:right;" href="javascript:history.forward(+1)">Page suivante&nbsp;&rsaquo;&rsaquo;</a>
		<h2>Annexe5&nbsp;: Information sur les doublons</h2>

<p><u>Comment se créent les doublons</u>&nbsp; ?</p>

<p>Un doublon peut être créé si la CAF modifie l'état civil de l'allocataire, notamment en lui ajoutant un NIR et en modifiant l'orthographe de son nom. L'application, se basant sur ces informations, ne reconnaît plus l'allocataire et l'enregistre donc comme une nouvelle personne.<br/> 
