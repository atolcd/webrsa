...
<head>
	...
	<div id="container">
		<div id="header"></div>
		<a name="haut"></a>
		<div style="height:100px"><h1>Didacticiel</h1><span style="margin-left:300px;font-size:12pt;"><b>...Guide utilisateur</b> Version 2.6.2</span><a href="http://www.seine-saint-denis.fr/" target="_blank"><img style="position:absolute;top:109px;right:10px;"src="/didac/images/logo_cg.jpg" width="178px" height="50px" alt="logo cg93"/></a></div>
		<hr/>
<div id="menu">
		<ul>
		<li id="activation"><a title="Page d'accueil" href="accueil">Accueil</a></li>
	...
	<ul><!--ici le sous menu géré avec CSS-->
		...
		<ul><li class="activation"><a title="Rechercher un bénéficiaire du RSA" href="cprechalloc">Cas pratique &nbsp;: Rechercher un dossier</a></li></ul>
		</li>
	</ul>
	<ul>	
		<li><a title="Affecter un référent à un allocataire" href="affectref">Affecter un référent</a>
		<ul><li class="activation"><a title="Remplacer un référent par un autre" href="cpaffectref">Cas pratique &nbsp;: Remplacer en masse un référent</a></li></ul>
		</li>
	</ul>
		<ul>
	...
	<ul>		
		<li class="activation"><a title="Les nouvelles orientations" href="cpnvorient">Cas pratique &nbsp;: Les nouvelles orientations</a></li>
		<li class="activation"><a title="La file active des CER" href="cpcerfa">Cas pratique &nbsp;: File active des CER</a></li>
		<li class="activation"><a title="Vos rendez-vous du jour" href="cprdvj">Cas pratique &nbsp;: Retrouver nos rendez-vous</a></li>
		<li class="activation"><a title="Informer les bénéficiaires"  href="cpinfoben">Cas pratique &nbsp;: Informer les bénéficiaires de leur RDV</a></li>
	</ul>
		</li>
	</ul>
		<ul>
		...
		<li><a href="pdf/Guide_utilisateur_final.pdf" target="_blank">Guide utilisateur (pdf)</a></li>
		<li><a href="pdf/Bureautique.pdf" target="_blank">Guide Bureautique (pdf)</a></li>
	...
	<div id="main" style="width:645px; height:1450px; border:solid 1px #000080; margin:0 30px 10px 30px;">
	<img style="position:absolute; top:-22px;right:2px;"  src="/didac/images/logo_cg.jpg" alt="logo cg93"/>
