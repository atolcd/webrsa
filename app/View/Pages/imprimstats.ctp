...
<ol><li>Fichier / Aperçu avant impression => Cliquer sur le bouton
Paysage</li>

<li>Fichier Mise en page => Onglet Format et echelle /adapter à la taille de la page Opter
pour 70% pour les D1 sur 2 pages. A 80% pour le D2 sur 1 page</li>

<li>Onglet Marges En-tête et pied de page : 1.7 partout</li>
<li>Fichier / Imprimer => Soit en PDF soit envoyer vers l'imprimante.</li></ol>
Soit&nbsp;:<br/>
A partir du menu fichier du navigateur<br/>
Fichier / Aperçu avant impression
</p><br/>
<img src="/didac/images/menunavi.jpg" alt="Menu du navigateur" width="377px" height="287px" />
<p>Cliquer sur le bouton "Paysage", Choisir l'échelle à 70%, cliquer sur "Mise en page".</p>
<img src="/didac/images/apernav.jpg" alt="Aperçu avant impression firefox" width="643px" height="253px" />
<p>Cliquez sur "Mise en page".<br/>
Dans la boite de dialogue "Mise en page", cliquer sur l'onglet "Marges, en-têtes et pieds de page".<br/>
Définir les marges entre 1,5cm et 1,7cm</p><br/>
<img src="/didac/images/mipafire.jpg" alt="Mise page firefox" width="436px" height="450px" /><br/>
<p>Une autre option est disponible à partir de la liste déroulante des échelles&nbsp;:</p>
<div style="position:relative;float:left;width:300px;">
<p>"Adapter à la page".
Néanmoins cette solution
Imprime les D1 sur 3 pages, et les 
D2 sur 2 pages.</p>
</div>

<img src="/didac/images/adapfx.jpg" alt="Menu du navigateur" width="190px" height="335px" />
<br/>
