...
<head>
	...
	<ul>	
		...
		<li id="activation"><a title="Annexe 8: Pré-requis WebRSA" href="ann8">Pré-requis WebRSA </a></li>
	...
	<a style="text-align:right;padding-right:15px;float:right;" href="javascript:history.forward(+1)">Page suivante&nbsp;&rsaquo;&rsaquo;</a>
		<h2>Annexe8&nbsp;: Pré-requis techniques pour l’installation de WebRSA</h2>

<ul>
<li>Un poste de travail avec connexion Internet sécurisée</li>
<li>Un navigateur Internet à jour permettant l'exécution de scripts JavaScript</li>
<li>Une suite bureautique Open Office ou Libre Office</li>
<li>Le logiciel Acrobat Reader</li>
<li>Le navigateur Firefox, en version 19 minimum, est préconisé</li>
<li>Un logiciel de visualisation de PDF</li>
...
<p>Seul le référent est habilité à contacter le Centre de Services.</p>

<p>Contact par téléphone : 01 43 93 97 17</p>
<p>Horaires : du lundi au jeudi de 8h30 à 17h30 et le vendredi de
8h30 à 17h.</p>
<p>Contact par mail 24h/24h : DSI_centreservices@cg93.fr</p>
<p><b>Comment suivre ses déclarations ?</b></p>
</div>
<ul>
<li>Une fois le Centre de Services contacté, une déclaration d’incident est faite
