...
<img src="/didac/images/modifdsp.jpg" alt="Modifier la DSP" width="476px" height="129px" />
<p>Les zones de saisie du formulaire de la DSP deviennent actives.</p>
<img src="/didac/images/actidsp.jpg" alt="Mise à jour de la DSP" width="605px" height="225px" />
<p>De nombreuses zones proposent des listes déroulantes &nbsp;:</p>
<img src="/didac/images/lisdsp.jpg" alt="Les items de liste de la DSP" width="605px" height="252px" />

<p>L'emploi recherché peut être renseigné de 2 manières
<ul><li>A partir des codes ROME</li>
<li>Dans une zone de saisie libre</li></ul></p>
<img src="/didac/images/romedsp.jpg" alt="Les codes ROME de la DSP" width="643px" height="203px" />
<p>Si vous restez un temps assez long devant l'écran sans activité, les listes des codes ROME doivent être réinitialisées avec Ctrl + F5 pour être de nouveau disponibles.<br/>
Sélection du métier directement à partir des listes : Code famille, code domaine, code métier, Appellation métier : Les listes sont interdépendantes.</p>

<img src="/didac/images/liromedsp.jpg" alt="Les codes ROME de la DSP" width="638px" height="178px" />
<p>Les listes de code ROME V3 sont disponibles sur le bloc de la situation professionnelle de l'allocataire, à 2 endroits :
<ul><li>Le passé professionnel</li><li>L'Emploi recherché</li></ul></p>


<p>Lorsqu'on modifie une <b><em>DSP</em></b>, on peut ensuite consulter les différences entre les mises à jour.</p>
<img src="/didac/images/diffdsp.jpg" alt="Les différences de versions de la DSP" width="605px" height="162px" />
<p>En cliquant sur le lien <u>Voir les différences</u>, on visualise les modifications entre les deux versions.</p>
<img src="/didac/images/versdsp.jpg" alt="Les différences de versions de la DSP" width="605px" height="359px" />
<p>Dans la colonne de gauche, les anciennes informations, dans la colonne de droite, les mises à jour de la DSP.</p>
