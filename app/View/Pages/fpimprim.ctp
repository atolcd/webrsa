...
<ol start="3"><li><a name="impfp">Impression de la fiche de prescription</a></li>
	<img src="/didac/images/limpfp.jpg" alt="Impression de la Fiche de Prescription" width="605px" height="108px" />

<p>Cliquer sur le lien <b><i>&quot;Imprimer&quot;</i></b>à partir de ce tableau afin de remettre la fiche au bénéficiaire.<br/>
La fiche est générée automatiquement au format pdf, et les informations saisies ou rapatriées automatiquement sont directement renseignées.</p>
	<img src="/didac/images/pdffp.jpg" alt="Impression de la Fiche de Prescription" width="605px" height="454px" />
<p>Les informations sont rapatriées  &nbsp;:</p>
<ul>
<li>La date de transmission.</li>
<li>Les coordonnées de votre structure.</li>
<li>Le nom du prescripteur (Chargé(e) d'insertion).</li>
<li>L'action prescrite.</li>
<li>L'état civil du bénéficiaire.</li>
<li>Les coordonnées du bénéficiaire.</li>
<li>La nature de la prestation.</li>
<li>Numéro CAF du bénéficiaire.</li>
<li>Inscription à Pôle Emploi.</li>
<li>Niveau d'étude.</li>
<li>Dates du CER (s'il y a un CER en cours).</li>
<li>La date et l'heure du rendez-vous avec le prestataire (si un rendez-vous a été fixé).</li>
<li>Les documents que le bénéficiaire doit apporter.</li>
</ul>
