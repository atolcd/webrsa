...
<div id="menu">
	...
	<a title="Aller à la page suivante" style="text-align:right;padding-right:15px;float:right;" href="javascript:history.forward(+1)">Page suivante&nbsp;&rsaquo;&rsaquo;</a>
		<h2>Les Recherches&nbsp;:&nbsp;<i>Présence des actions des allocataires transférés dans les résultats des recherches</i></h2>
<div class="nav">
...
<ol start="9"><li style="margin-top:25px;"><a name="dsp">Présence des actions des allocataires transférés dans les résultats des recherches</a></li></ol>
<p>Les actions effectuées (Orientation, RDV, CER, Fiche de prescription) pour les allocataires ayant déménagés apparaissent dans les résultats des formulaires de recherches. <br/>


À partir de tous les formulaires de recherche, les dossiers des Allocataires ayant déménagé sont présents dans les résultats de la requête.<br/>

Exemple: <u>Formulaire de Recherche par rendez-vous</u> :<br/>

</p>
<img src="/didac/images/exrdv.jpg" alt="Recherche par RDV" width="606px" height="313px" />
<p>Lorsque vous effectuez une recherche sur les rendez-vous individuels d'un mois donné, vous récupérez dans vos résultats tous vos rendez-vous, y compris ceux des bénéficiaires ayant quittés votre commune.
<br/>La capture d'écran ci-dessous vous retourne un bénéficiaire ayant déménagé sur Paris, parmi ceux des Lilas.
</p>
<ul><li>Visibilité des dossiers mutés dans les formulaires de recherche</li></ul>
<img src="/didac/images/exresrdv.jpg" alt="Recherche par RDV" width="605px" height="239px" />
<p class="nb">NB&nbsp; :&nbsp; Les dossiers mutés se différencient par le lien "Voir" inactif</p>
