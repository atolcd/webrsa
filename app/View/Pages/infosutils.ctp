...
<div id="menu">
	...
	<ul>		
		...
		<li id="activation"><a title="Annexe 7: Vider le cache du navigateur" href="infosutils">Informations aux utilisateurs </a></li>
...
<h2>Annexe7&nbsp;: Informations aux utilisateurs WebRSA </h2>

<ol>
<li>Vider le cache après une montée de version</li></ol>
<p>Vider le cache signifie "Actualiser l'affichage"&nbsp;: Il s'agit de supprimer l'historique des pages consultées.</p>
<p>A chaque montée de version, les utilisateurs devront vider le cache afin que toutes les améliorations soient prises en compte dans la nouvelle version.</p>
<p>Sur le navigateur préconisé, FireFox  &nbsp;:</p>
<ul><li>Aller dans Outil -> Options</li></ul>

<img src="/didac/images/fxoptions.jpg" alt="" width="605px" height="173px" />
<ul><li>cliquer sur l’icône "Vie privée"</li></ul>
<img src="/didac/images/fxviprive.jpg" alt="Firefox" width="605px" height="406px" />
<ul><li>Cliquer sur "effacer votre historique récent"</li></ul>
<p>Sur la nouvelle fenêtre, sélection la valeur "cache" et la valeur "tout" puis cliquer sur le bouton "Effacer maintenant".</p>
<img src="/didac/images/fxhistoriq.jpg" alt="" width="605px" height="347px" />

<ol start="2"><li>Activer JavaScript</li></ol>
<p>Certaines fonctionnalités de WebRSA fonctionnent avec JavaScript (comme la visualisation des commentaires par exemple).
JavaScript est en principe activé par défaut dans la plupart des navigateurs récents.</p>
<p>Menu Outils /Options</p>
<img src="/didac/images/fxoutoptio.jpg" alt="Options de firefox" width="279px" height="197px" />
<ul>
<li>Cliquer sur l'onglet "Contenu"</li>
<li>Cocher la case "Activer JavaScript</li>
</ul>
<img src="/didac/images/fxactijs.jpg" alt="Activer javascript" width="546px" height="537px" />
<p></p>
<ol start="3"><li>Télécharger les fichiers</li></ol>
<p>Lorsque vous aurez besoin d'exporter des données pour travailler avec Excel, il peut être pratique d'indiquer un chemin vers un dossier pour stocker vos données ou de choisir à chaque fois un dossier d'enregistrement.</p>
<p>Depuis le menu Outils de Firefox, cliquer sur Options.</p>
<img src="/didac/images/fxoutoptio.jpg" alt="Options de firefox" width="279px" height="197px" />
<p>Dans l'onglet Général de la boite d'options, cliquer sur "parcourir".</p>
<img src="/didac/images/fxgeneral.jpg" alt="Onglet général" width="546px" height="441px" />
<p>Le dossier téléchargement est par défaut celui où se stockent les fichiers.</p>
<img src="/didac/images/fxdossiers.jpg" alt="Choisir un dossier" width="327px" height="329px" />
<p>Sélectionner le dossier de destination de vos téléchargements.</p>
<p>L'autre possibilité est de choisir à chaque fois le dossier de destination de votre téléchargement  &nbsp;:</p>
<img src="/didac/images/fxtel.jpg" alt="Télécharger le fichier" width="546px" height="451px" />
<p></p>
