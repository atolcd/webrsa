...
<!-- suivi de l'action-->
	<ol start="5"><li>Renseignement du suivi de l’action</li>
<p>Cette étape n'est pas obligatoire.<br/>
Le référent peut prendre contact avec le partenaire / prestataire à tout moment y compris avant la prestation et recueillir des informations sur la fiche de prescription d'un allocataire qu'il soit amené à participer ou pas à la prestation.<br/>
Si les champs sont renseignés alors le statut de la fiche = Suivi renseigné.<br/>
Une fois que l'action est effective, il vous faudra renseigner le suivi.<br/></p>	
	<img src="/didac/images/fpsui.jpg" alt="Suivi de l'action Fiche de Prescription" width="675px" height="805px" />
<p>Dans le cas où la personne n'aurait pas été reçue en entretien, il faudra en préciser le motif ou éventuellement renseigner le champ "Autre" (le champ de saisie libre s'active lorsque l'item "Non" est sélectionné.</p>	
	
	<img src="/didac/images/fpsuimo.jpg" alt="Suivi de l'action Fiche de Prescription" width="618px" height="131px" />
	<p>Les champs de suivi de l'action&nbsp; :</p>
<ul><li>La personne a été reçue en entretien <b><i>Oui&nbsp; / &nbsp;Non</i></b>.</li>
<li>La personne a été retenue par la structure <b><i>Oui&nbsp; / &nbsp;Non</i></b>.</li>
<li>La personne souhaite intégrer l'action <b><i>Oui&nbsp; / &nbsp;Non</i></b>.</li>
<li>L'allocataire a intégré l'action <b><i>Oui&nbsp; / &nbsp;Non</i></b>.</li></ul>
<p>A la fin vous pouvez renseigner les dates du bilan&nbsp; :<br/>
A mi parcours
</p>
	<img src="/didac/images/fpsuibil.jpg" alt="Suivi de l'action Fiche de Prescription" width="669px" height="130px" />
<p>Au final</p>
	<img src="/didac/images/fpsuifin.jpg" alt="Suivi de l'action Fiche de Prescription" width="612px" height="115px" />
<p><u>Infos pour les statistiques:</u></p>
<p>Les fiches de prescription qui sont "En attente", ou dont le code convention commence par NF, ou qui ne sont pas "Signée" ne sont pas comptabilisées dans les statistiques.</p>
<p>Les prescriptions qui renseignent le <b><i>B4</i></b></p>
<ul><li>Acteurs Sociaux</li>
<li>Acteurs de la santé</li>
<li>Culture loisirs vacances</li></ul>

<p>Les prescriptions qui renseignent le <b><i>B5</i></b></p>
<ul><li>Professionnelles</li>
<li>Socioprofessionnelles</li>
<li>Pôle Emploi</li></ul>
<p><u>Rappel</u>&nbsp;:
Avant la signature, le statut de la fiche = Renseignée <br/>
Si le champ signé est renseigné alors le statut de la fiche = Signée<br/>
Si les champs de la rubrique résultat de l’effectivité sont renseignées = Effectivité renseignée (Oui / non)<br/>
Si les champs dans suivi de l’action sont renseignés alors le statut de la fiche = Suivi renseigné<br/><br/>

Sur la synthèse du parcours d'insertion de l'allocataire, l'étape 6 est renseignée.</p>

<img src="/didac/images/fpstafic.jpg" alt="Suivi de l'action Fiche de Prescription" width="605px" height="69px" />
</ol>
<br/>
