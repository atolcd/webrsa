...
<ol start="4"><li><a name="grasdsp"></a>Mise en gras des champs incrémentés dans le tableau de bord B3</li></ol>
<p>A l'exception du niveau d'étude qui s'incrémente dans le tableau de bord D1, les difficultés sociales s'incrémentent dans le tableau B3.</p>
<p>Sur le formulaire de saisie des DSP, les réponses en gras s'incrémentent dans le tableau B3.</br>
Les difficultés sociales.</p>
<img src="/didac/images/dspdifsoc.jpg" alt="Ajouter une DSP" width="690px" height="444px" />
<p>Les obstacles à la recherche d'emploi : les modes de garde.</p>
<img src="/didac/images/dspmogar.jpg" alt="Ajouter une DSP" width="690px" height="133px" />
<p>Les réponses sur le niveau d'étude s'incrémentent dans le questionnaire D1.</p>
<img src="/didac/images/dspnivetu.jpg" alt="Ajouter une DSP" width="690px" height="136px" />
<p>La disponibilité pour l'emploi : Réponse<b><i> "Non"</i></b></p>
<img src="/didac/images/dspdisempl.jpg" alt="Ajouter une DSP" width="690px" height="64px" />

<p>Les difficultés de logements</p>
<img src="/didac/images/dspdiflog.jpg" alt="Ajouter une DSP" width="690px" height="291px" />
