<?php
	...
	class CsvHelper extends Helper
	{
		...
		*/
		...
		public function addGrid( $data, $addFieldNames = true, $fieldList = null ) {
			if (!$data) {
				return false;
			}
	...
	/**
	* A PHP4 implementation of the equivalent PHP5 public function
	*
	* See (http://www.php.net/manual/en/public function.fputcsv.php) for details
	*/
