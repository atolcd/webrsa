...
// +----------------------------------------------------------------------+
//
require_once "GDO_Utility.php";
require_once "GDO_FieldType.php";
require_once "GDO_ContentType.php";
require_once "GDO_IterationType.php";
require_once "GDO_PartType.php";
require_once "GDO_FusionType.php";
require_once "GDO_MatrixType.php";
require_once "GDO_MatrixRowType.php";
require_once "GDO_AxisTitleType.php";
...
class GDO_XML2GEDOOo
{
     ...
     * @access   public
     */
    public function ElmtToField($oElmt)
    {
     ...
     * @access   public
     */
    public function ElmtToIteration($oElmt)
    {
     ...
     * @access   public
     */
    public function ElmtToContent($oElmt)
    {
        ...
        $bIsURL = 1 === preg_match("/(http|file):\/\/.*/i", $sValue);
        ...
        if ($bIsURL) {
            switch ($sType) {
                ...
                case "image":
                    ...
                    if (1 !== preg_match("/^image\/.*/", $sMimeType)) {
                        $sMimeType="image";
                    }
                    break;
                case "content":
                    $sMimeType = $u->getMimeType($sValue);
                    if (1 !== preg_match("/^application\/.*/", $sMimeType)) {
     ...
     * @access   public
     */
    public function ElmtToFieldOrContent($oElmt)
    {
        $aElements = array();
    ...
    public function ElmtToMatrix($oElmt)
    {

        $aElmt = $oElmt->children();
        //
        // Recherche de la balise "target"
        // normalement en première position
    ...
    public function ElmtToMatrixElement($oElmt)
    {
    ...
    public function ElmtToAxisTitles($oElmt)
    {
        ...
        if (isset($aAxisTitles)) {
            $oAxisTitles->setDescription($aAxisTitles);
        }
     ...
     * @access   public
     */
    public function ElmtToPart($oElmt)
    {
    ...
    public function XMLToPart($sXMLparm)
    {
