 ...
 *
 * Adullact: pris des sources de CakePHP 2.2.4 avec un correctif concernant les cases à cocher.
 *
 * @package       Cake.View.Helper
 ...
 */
	protected function _selectOptions($elements = array(), $parents = array(), $showParents = null, $attributes = array()) {
		...
		foreach ($elements as $name => $title) {
			...
			if ($name !== null) {
				// INFO: début Adullact pour que la case à cocher '0' ne se coche pas lorsqu'elle ne le doit pas. cf. Cake 2.5.x
				...
				// INFO: fin Adullact pour que la case à cocher '0' ne se coche pas lorsqu'elle ne le doit pas. cf. Cake 2.5.x
				) {
					if ($attributes['style'] === 'checkbox') {
