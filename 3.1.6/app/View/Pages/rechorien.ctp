...
<div id="menu">
	...
	<a title="Aller à la page suivante" style="text-align:right;padding-right:15px;float:right;" href="javascript:history.forward(+1)">Page suivante&nbsp;&rsaquo;&rsaquo;</a>
		<h2>Les Recherches&nbsp;:&nbsp;<i>Par orientation</i></h2>
<div class="nav">
...
<ol start="2"><li style="margin-top:25px;"><a name="orientation">La recherche par orientation</a></li></ol>
...
<p>Si vous souhaitez consulter les bénéficiaires qui ont été réorientés vers votre structure suite à une réorientation (après la concertation locale dans la plupart des cas), sélectionner l'item '<b><i>Réorientation</i></b>'&nbsp;:</p>
<p>Les résultats renvoient tous les allocataires de votre commune qui ont été réorientés.
Pour ceux dont la réorientation est "socioprofessionnelle", vous pouvez consulter l'orientation initiale sur le dossier, en cliquant sur le lien <u>Voir</u>.</p>
<img src="/didac/images/rans.jpg" alt="Recherche par orientation" width="605px" height="227px" />
...
<img src="/didac/images/reorien.jpg" alt="Recherche par orientation" width="690px" height="300px" />
<p>Il est toujours possible de télécharger les résultats au format Excel en cliquant sur le bouton "Télécharger le tableau".</p>

<p><u>Recherche par type d’orientation</u></p>
<img src="/didac/images/rpoo.jpg" alt="Recherche par orientation" width="605px" height="168px" />
<p><u>Recherche par statut de l'orientation</u></p>
<img src="/didac/images/rso.jpg" alt="Recherche par orientation" width="610px" height="83px" />
<br/>
