...
<div id="menu">
	...
	<a title="Faire des requêtes" href="recherches">Les Recherches</a> > <i>Cas pratique&nbsp;:Générer les courriers.</i>
		<h2>Informer les bénéficiaires de leur rendez-vous</h2>
		
		
<!--Cas rdv-->
<p><i>Cas pratique : Comment informer par courrier les bénéficiaires de leur rendez-vous ?</i><br/>
Exemple d'une secrétaire qui souhaite générer les courriers des rendez-vous du mois  &nbsp;:</p>
<img src="/didac/images/pubrdv.jpg" alt="Rendez-vous du mois" width="692px" height="272px" />
<ul>
<li>Statut du RDV (prévu)</li>
<li>Filtrer par date de RDV</li>
<li>Définir l'amplitude des dates des rendez-vous</li>
<li>Choisir votre structure de parcours (ce qui vous permet de récupérer les rendez-vous pris avec des allocataires orientés emploi ou SSD.</li>
<li>Cocher éventuellement la case "Obtenir le nombre total de résultats".</li>
</ul>
<p><u>Résultats</u>&nbsp;:</p>
<img src="/didac/images/resmrdv.jpg" alt="Résultat des rendez-vous du mois" width="605px" height="395px" />
<p>Le bouton "Télécharger le tableau" vous permet d'exporter les données au format Excel et de pouvoir les utiliser comme source de données pour le publipostage (après conversion du fichier .csv)  &nbsp;: Se référer à la partie <a href="/didac/pdf/Bureautique.pdf" target="_blank">bureautique</a> pour la conversion du fichier puis la liaison avec word.</p>
