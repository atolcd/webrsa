...
<div id="menu">
	...
	<a title="Faire des requêtes" href="recherches">Les Recherches</a> > &nbsp;<i>Cas pratique&nbsp;:Les orientations.</i>
		<h2>La recherche par orientation</h2>

<p><em>Cas pratique  &nbsp;: Recherche des nouvelles orientations de bénéficiaires chaque mois</em></p>
<p>Menu &laquo;Recherches&raquo; puis sélectionnez &laquo;Par Orientation&raquo; ensuite cochez les cases&nbsp;<img class="bimg" src="/didac/images/casecoch.jpg" alt="Case à cocher" width="45px" height="40px" />&nbsp;  indiquées sur les copies d’écrans.<br/>Faites &laquo; Rechercher&raquo;&nbsp;et un tableau de résultat s’affiche.<br/>Enfin, téléchargez le fichier en appuyant sur le bouton &nbsp;<img class="bimg" src="/didac/images/teltab.jpg" alt="Télécharger le tableau" width="177px" height="41px" /></p>
<img src="/didac/images/mro.jpg" alt="Recherche par orientation" width="539px" height="273px" />
<img src="/didac/images/cpro.jpg" alt="Recherche par orientation" width="498px" height="478px" />
<img src="/didac/images/rcpoed.jpg" alt="Recherche par orientation" width="601px" height="209px" />
<img src="/didac/images/rdpo.jpg" alt="Recherche par orientation" width="674px" height="286px" />
<br/>
