...
<div id="menu">
	...
	<a style="text-align:right;padding-right:15px;float:right;" href="javascript:history.forward(+1)">Page suivante&nbsp;&rsaquo;&rsaquo;</a>
		<h2>Les statistiques&nbsp;:&nbsp;<i>Les tableaux B4</i></h2>
<div class="nav">
...
<ol start="3"><li><a name="presc">Prescription vers des acteurs sociaux, culturels et de santé B4</a></li></ol>
<img src="/didac/images/pbs.jpg" alt="Les acteurs sociaux, culturels et de santé" width="427px" height="419px" />
<img src="/didac/images/pb4.jpg" alt="Les acteurs sociaux, culturels et de santé" width="643px" height="83px" />
<p>Le tableau B4 vous permet de filtrer :

<ul><li>Sur l'année</li>
<li>Selon les prescriptions d'action PDI</li>
<li>Selon les prescriptions d'action Hors PDI</li>
<li>Sans filtre sur les actions PDI ou Hors PDI </li></ul></p>

<img src="/didac/images/prespbs.jpg" alt="Les acteurs sociaux, culturels et de santé" width="642px" height="232px" />
<p><b>B4 : Prescriptions vers les acteurs sociaux, culturels et de santé</b></p>
<img src="/didac/images/statsb4.jpg" alt="Prescription vers les acteurs sociaux, culturels et de santé" width="228px" height="514px" />
<div style="width:417px; float:right;" ><p>La thématique sélectionnée sur la fiche de prescription renseigne le tableau B4.<br/><u>Pour les actions du PDI</u></p><ul><li>Acteurs de la santé => Prescription santé</li></ul><img src="/didac/images/pdipas.jpg" alt="Prescription vers les acteurs sociaux, culturels et de santé" width="381px" height="270px" /></div>
<ul><li>Acteurs socio => Prescription sociale.</li></ul>
<u>Pour les actions Hors PDI</u>

<ul><li>Prescription Santé</li></ul>
<img src="/didac/images/b4san.jpg" alt="Prescription vers les acteurs santé" width="620px" height="223px" />
<ul><li>Prescription Sociale</li></ul>

<img src="/didac/images/b4soc.jpg" alt="Prescription vers les acteurs sociaux" width="363px" height="189px" />

<p>Pour que le B4 soit renseigné, il faut que le bloc "Engagement" correspondant à la signature du bénéficiaire soit renseigné.</p>
