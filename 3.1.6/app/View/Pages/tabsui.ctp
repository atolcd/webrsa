...
<div id="menu">
	...
	<ul>	
		...
		<li  id="activation"><a href="tabsui">Le tableau de suivi</a></li>
...
<p>Le tableau de suivi permet de suivre les étapes de saisie et de validation des CER. (CER Enregistré, Validé responsable ou rejeté responsable, Pré-validé ou à relire, Validé CS ou avis cadre, Passage en EP ...)&nbsp;: Ce tableau vous permet de consulter les statuts de vos CERs à toutes les étapes en temps réel.<br/>Sur le menu CER->Tableau de suivi.</p>		
...
<img src="/didac/images/exptabsui.jpg" alt="Exporter de suivi" width="605px" height="85px" />
<br/>
