...
<div id="menu">
		...
		<li  id="activation"><a title="Introduction à WebRSA" href="intro">Introduction</a></li>
...
<a style="text-align:left;" href="javascript:history.back()">&lsaquo;&lsaquo;&nbsp;Page précédente</a>&nbsp;
	<a style="text-align:right;padding-right:15px;float:right;" href="javascript:history.forward(+1)">Page suivante&nbsp;&rsaquo;&rsaquo;</a>
		<h2>Introduction</h2>
		<p><u>WebRSA est un outil d’appui aux missions d’accompagnement des professionnels de l’insertion</u>.</p>
<ol><li>Historique</li></ol>
<ul>
<li>En 2009, le Département de la Seine-Saint-Denis a choisi de mettre en œuvre le logiciel WebRSA pour l’informatisation du Revenu de Solidarité Active (RSA).</li>
<li>L’outil de gestion WebRSA est une application qui permet de faciliter le suivi des démarches d’insertion des bénéficiaires du Revenu de Solidarité Active (RSA).</li>
</ul>

<ol start="2"><li>Déploiement de WebRSA  &nbsp;: Pour quoi faire ?</li></ol>
<ul>
<li>Un outil unique de suivi des données sur l’allocation et le parcours.</li>
...
<li>Le Département oriente les bénéficiaires du RSA vers les structures référentes. L’équipe de chargés d’insertion, qui accompagnent les bénéficiaires dans leur suivi socioprofessionnel, valorise les différentes étapes du parcours par la rédaction d’un Contrat d’Engagement Réciproque. Rendu obligatoire par la loi, le Contrat d’Engagement Réciproque est un outil de suivi du parcours et de mobilisation de l’offre d’insertion et de l’allocataire. Il rend compte de la cohérence des étapes et de la progression du parcours.</li>
<li>Chaque structure référente reçoit son porte-feuille de suivis et parallèlement, chaque bénéficiaire reçoit également chez lui sa notification d’orientation qui mentionne les coordonnées de sa structure référente</li>
<li>La structure référente invite et accueille les bénéficiaires pour amorcer l’accompagnement et les démarches d’insertion, à partir du listing extrait de WebRSA (liste des bénéficiaires orientés)</li>
...
<p>Les décisions sur les CER sont prises par le Service de l’Insertion et de la Solidarité (SIS) du Département. Les décisions sont visibles dans le <i>tableau de suivi</i>.</p>
<br/>
