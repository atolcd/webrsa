...
<div id="menu">
	...
	<a style="text-align:right;padding-right:15px;float:right;" href="javascript:history.forward(+1)">Page suivante&nbsp;&rsaquo;&rsaquo;</a>
		<h2>Les statistiques&nbsp;:&nbsp;<i>Les tableaux B6</i></h2>
<div class="nav">
...
<ol start="5"><li><a name="acol">Les actions collectives B6</a></li></ol>
<img src="/didac/images/act.jpg" alt="Les actions collectives" width="427px" height="421px" />
<img src="/didac/images/actcol.jpg" alt="Les actions collectives" width="605px" height="83px" />
<p class="nb"><b>B6 : Actions collectives</b></p>
<p><b>Pré-requis</b></p>
<p>Pour le nombre de personnes <u>invitées ou positionnées</u>&nbsp; : L’allocataire doit avoir un <u>RDV honoré ou prévu</u> dans l’année.
Pour le nombre <u>participants</u>&nbsp; : L’allocataire doit avoir un <u>RDV honoré</u> dans l’année.
</p>

<img src="/didac/images/bac.jpg" alt="Les actions collectives" width="643px" height="134px" />
<img src="/didac/images/baci.jpg" alt="Les actions collectives" width="643px" height="254px" />
<img src="/didac/images/rdvbac.jpg" alt="Les actions collectives" width="605px" height="351px" />
<p>Pour les rendez-vous des <b><i>informations collectives</i></b> : Vous devez les passer à "<b><i>honorés</i></b>", sinon ils ne sont pas comptabilisés dans les statistiques.</p>
<p><u>Résultat</u> &nbsp;:</p>
<img src="/didac/images/resactcol.jpg" alt="Les actions collectives" width="605px" height="354px" />
<p><u>Dispositions concernant les tableaux  restants non disponibles sur Webrsa à ce jour</u>&nbsp;:<br/>Les tableaux  B1, B2 et B7 ne seront pas mis à disposition en 2014 sur WebRSA, faute de développement. </p>
<p>Concernant le tableau B7, il est en cours de spécification.</p>
