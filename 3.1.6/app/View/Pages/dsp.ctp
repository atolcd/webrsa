...
<div id="menu">
	...
	<!-- 	<ul><li id="activ"><a title="Remplacer un référent par un autre" href="cpaffectref">Cas pratique &nbsp;: Remplacer en masse un référent</a></li></ul> -->
		...
		<li  id="activation"><a href="dsp">La DSP</a></li>
...
<p>Le référent a la possibilité de renseigner une première DSP ou de modifier la DSP existante pour mettre à jour des informations socio-professionnelles. </p>
<p><b>Rechercher un dossier Allocataire</b></p>
<img src="/didac/images/allocdsp.jpg" alt="Renchercher un allocataire" width="605px" height="202px" />
<p>Cliquer sur le lien <u>Voir</u> dans la liste de résultat pour accéder au dossier.</p>
<p>Sur le dossier  &nbsp;: Cliquer sur le "+"&nbsp;<img class="bimg"src="/didac/images/bplus.jpg" alt="Le bouton Plus" width="20px" height="21px" />&nbsp; pour accéder aux informations, puis cliquer sur le lien <u>DSP</u>.</p>

<img src="/didac/images/liendsp.jpg" alt="Renchercher un allocataire" width="605px" height="227px" />
<p>On peut constater la présence ou non d’une DSP.</p>
<p>Si une DSP est présente on a le bouton "Modifier" d'actif:&nbsp;<img class="bimg" src="/didac/images/bmodif.jpg" alt="Bouton Modifier" width="85px" height="37px" /> </p> 
<p>Si la DSP est absente, on a le bouton "Ajouter" d'actif :&nbsp;<img class="bimg" src="/didac/images/bajout.jpg" alt="Bouton Ajouter" width="85px" height="35px" />  </p>

<ol>
<li><a name="rub"></a>Les rubriques de la DSP</li></ol>
<ol type="A"><li class="rubrique">Généralités</li>
	<p>Les <b>champs renseignés</b> apparaissent en <b>gras</b>.</p>
		<img src="/didac/images/gendsp.jpg" alt="Généralités DSP" width="605px" height="360px" />
<li class="rubrique">Situation sociale</li>
	<img src="/didac/images/ssdsp.jpg" alt="Situation sociale DSP" width="605px" height="539px" />
<li class="rubrique">Niveau d'étude</li>
	<img src="/didac/images/nedsp.jpg" alt="Niveau d'étude DSP" width="605px" height="389px" />
<li class="rubrique">Disponibilités emploi</li>
	<img src="/didac/images/dedsp.jpg" alt="Disponibiltés emploi DSP" width="605px" height="76px" />

<li class="rubrique">Situation professionnelle</li>

<img src="/didac/images/spdsp.jpg" alt="Situation professionnelle DSP" width="605px" height="775px" />

<li class="rubrique">Mobilité</li>

<img src="/didac/images/mobdsp.jpg" alt="Mobilité DSP" width="605px" height="170px" />

<li class="rubrique">Difficultés de logement</li>

<img src="/didac/images/dldsp.jpg" alt="Difficultés de logement DSP" width="605px" height="256px" />
</ol>
