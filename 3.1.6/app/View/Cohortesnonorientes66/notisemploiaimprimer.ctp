...
<?php echo $this->Xform->create( 'Cohortenonoriente66', array( 'type' => 'post', 'action' => 'notisemploiaimprimer', 'id' => 'Search', 'class' => ( ( is_array( $this->request->data ) && !empty( $this->request->data ) ) ? 'folded' : 'unfolded' ) ) );?>
            ...
            <?php
				...
				$tableCells = array(
						...
						$this->Xhtml->printLink(
							...
							$this->Permissions->check( 'cohortesnonorientes66', 'impression' )
						),
