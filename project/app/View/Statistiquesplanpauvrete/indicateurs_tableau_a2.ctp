...
<?php if( !empty( $this->request->data ) ) { ?>
	<h2> <?php echo __d('statistiquesplanpauvrete', 'Statistiquesplanpauvrete.menu.indicateurs_tableau_a2', '') ?> </h2>
	<?php
		...
		<li><?php
			echo $this->Xhtml->exportLink(
				...
				array( 'action' => 'exportcsv_tableau_a2', 'visualisation' ) + Hash::flatten( $this->request->data, '__' ),
				true
			);
		?></li>
		</ul>
