...
<table width="60%">
    <thead>
        <th width="20%"><?= __d('modecontact', 'fixe'); ?></th>
        <th width="20%"><?= __d('modecontact', 'mobile'); ?></th>
        <th width="60%"><?= __d('modecontact', 'mail'); ?></th>
    </thead>
    <tbody>
        <tr class="even">
...
<table width="60%">
    <thead>
        <th width="20%"><?= __d('modecontact', 'tel'); ?></th>
        <th width="20%"><?= __d('modecontact', 'tel2'); ?></th>
        <th width="40%"><?= __d('modecontact', 'mail'); ?></th>
        <th width="20%"><?= __d('modecontact', 'date'); ?></th>
    </thead>
    <tbody>
