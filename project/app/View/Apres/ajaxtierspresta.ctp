<?php if( !empty( $tiersprestataireapre ) ):?>
	<table class="wide noborder">
		...
		<tr>
			<td class="wide noborder"><?php echo Set::classicExtract( $tiersprestataireapre, 'Tiersprestataireapre.numvoie' ).' '.Set::classicExtract( $tiersprestataireapre, 'Tiersprestataireapre.typevoie' ).' '.Set::classicExtract( $tiersprestataireapre, 'Tiersprestataireapre.nomvoie' ).' '.Set::classicExtract( $tiersprestataireapre, 'Tiersprestataireapre.codepos' ).' '.Set::classicExtract( $tiersprestataireapre, 'Tiersprestataireapre.ville' );?></td>
