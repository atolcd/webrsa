<?php
	/**
	 * Code source de la classe WebrsaAccessTitressuivisannulationsreductions.
	 *
	 * PHP 5.3
	 *
	 * @package app.Utility
	...
	/**
	 * La classe WebrsaAccessTitressuivisannulationsreductions ...
	 *
	 * @package app.Utility
	 */
	abstract class WebrsaAccessTitressuivisannulationsreductions extends WebrsaAbstractAccess
	{
		/**
		...
		public static function params(array $params = array()) {
			return $params + array(
				'alias' => 'Titressuivisannulationsreductions',
		 ...
		 * @return boolean
		 */
		protected static function _print(array $record, array $params) {
			return true;
		}
