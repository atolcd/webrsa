...
CASE fichesprescriptions93.rdvprestataire_date
	when null then null
	ELSE to_char( fichesprescriptions93.rdvprestataire_date, 'YYYY-MM-DD')|| 'T' ||to_char( fichesprescriptions93.rdvprestataire_date, 'HH24:MI')
END AS "date_entretien",
