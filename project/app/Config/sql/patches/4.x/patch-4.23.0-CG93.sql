...
'{"filters":{"defaults":{"Dossier":{"dernier":1,"dtdemrsa":1,"dtdemrsa_from":{"year":2012,"month":1,"day":1}},"Situationdossierrsa":{"etatdosrsa_choice":1,"etatdosrsa":[2]},"Detaildroitrsa":{"oridemrsa_choice":1,"oridemrsa":["DEM","RMI","API"]},"Calculdroitrsa":{"toppersdrodevorsa":1},"Orientstruct":{"statut_orient":"Non orienté"}},"accepted":[],"skip":[]},"query":{"restrict":[],"conditions":[],"order":[]},"limit":10,"auto":false,"results":{"header":[],"fields":{"0":"Dossier.numdemrsa","1":"Personne.nom","2":"Personne.prenom","3":"Dossier.dtdemrsa","4":"Dossier.matricule","5":"Adresse.numvoie","6":"Adresse.libtypevoie","7":"Adresse.nomvoie","8":"Adresse.nomcom","9":"Adresse.codepos","10":"Adresse.compladr","/Adressesfoyers/index/#Foyer.id#":{"class":"view"}},"innerTable":["Situationdossierrsa.etatdosrsa","Personne.nomcomnai","Personne.dtnai","Adresse.numcom","Personne.nir","Historiqueetatpe.identifiantpe","Modecontact.numtel","Prestation.rolepers","Structurereferenteparcours.lib_struc","Referentparcours.nom_complet"]},"ini_set":{"max_execution_time":0,"memory_limit":"1024M"}}',
