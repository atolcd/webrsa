...
-- Mise à jour des nouvelles variables de configuration
UPDATE public.configurations SET value_variable = true WHERE lib_variable = 'Orientstruct.recalculerang';
UPDATE public.configurations SET value_variable = false WHERE lib_variable = 'Orientstruct.changeorigine';
