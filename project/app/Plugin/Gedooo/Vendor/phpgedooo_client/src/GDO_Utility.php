...
class GDO_Utility
{
     ...
     *
     * @return   binary      Le contenu du fichier dans l'état
     * @since    1.0
     * @access   public
     */
    public function ReadFile($sFileName)
    {
        $sData = '';
        //echo $sFileName;
     ...
     * @param    binary      $bData Le contenu à écrire
     * @since    1.0
     * @access   public
     */
    public function WriteFile($sFileName, $bData)
    {
 ...
 */
    ...
    /**
     * Détermination d'un type MIME à partir d'une extension
     *
    ...
    public function extensionToMimeType($sExtension)
    {
    ...
    /**
     * Détermination d'un type MIME à partir d'un nom de fichier
     *
     ...
     */
    public function mimeTypeToExtension($sMimeType)
    {
    ...
    /**
     * Ajout d'une extension à un nom de fichier
     *
     * @param    string     $sName           Nom de fichier ï¿½ complï¿½ter
     * @param    string     $sTypeMime       Type MIME
     * @since    1.0
     * @access   public
     * @return   string     Nom de fichier complet
     */
    public function completeFileName($sName, $sMimeType)
    {
