<?php
	/**
	 * Code source de la classe SearchFiltresdefautComponent.
	 *
	 * PHP 5.3
	 *
	 * @package Search
	...
	/**
	 * La classe SearchFiltresdefautComponent permet de mettre des valeurs par défaut
	 ...
	 *	'SearchFiltresdefaut' => array( 'index' )
	 * );
	 * </pre>
	 *
	 ...
	 * <pre>
	 * Configure::write(
	 * 	'SearchFiltresdefaut.Dossiers_index',
	 * 	array(
	 * 		'Dossier.dernier' => '1',
	 ...
	 * @subpackage Controller.Component
	 */
	class SearchFiltresdefautComponent extends Component
	{
		/**
		 * Le nom du component.
		 *
		...
		/**
		 * Le préfixe qui sera utilisé dans la configuration.
		 *
		 * @var string
		 */
		public $configureKeyPrefix = 'Filtresdefaut';
		...
		public function configureKey() {
			...
			return "{$this->configureKeyPrefix}.{$Controller->name}_{$Controller->action}";
		}

		/**
		 * Retourne les valeurs par défaut du formulaire pour la clé courante.
		 *
		 * @see SearchFiltresdefautComponent::configureKey()
		 *
		 * @return array
		 */
		 ...
		 * stockée dans "{$this->configureKeyPrefix}.{$Controller->name}_{$Controller->action}".
		 *
