<?php
	/**
	 * Code source de la classe WebrsaCohortePlanpauvreterendezvousInfocolImprimeRdvCerStock.
	 *
	 * PHP 7.2
	 *
	 * @package app.Model
	 ...
	 * @package app.Model
	 */
	class WebrsaCohortePlanpauvreterendezvousInfocolImprimeRdvCerStock extends WebrsaCohortePlanpauvreterendezvous
	{
		/**
		...
		public function searchQuery( array $types = array(), $nouvelentrant = false ) {
			...
			$query = $this->requeteParRendezvous ($query, 'cohorte_infocol_rdv_cer_imprime_stock');
