<?php
	...
	class Statistiqueplanpauvrete extends AppModel
	{
		 ...
		 * @return array
		 */
		private function _initialiseResults( &$resultats, $tableau = 'TableauA1' ) {
		 ...
		 *
		 * @see Statistiqueplanpauvrete::_completeQueryDspDspRev()
		 *
		 * @param array $search
		 * @return array
		 */
		 ...
		 * de l'année, au sens de la loi " de la partie "Questionnaire orientation".
		 *
		 * @see Statistiqueplanpauvrete::_getFieldsNivetu()
		 *
		 * @param array $query
		 * @param array $search
		 * @return array
		...
		*/
		 ...
		 * @return array
		 */
		protected function _generateResults( array $results, &$resultats, $configuration, $tableau = 'TableauA1' ) {
...
*/
		 ...
		 *
		 */
		private function _getConfigStatistiqueplanpauvrete () {
			$conf = array();

			$conf['organismes'] = $this->_getConfigOrganismesplanpauvrete();
			$conf['actions_cer'] = $this->_getConfigActionsCer();
			$conf['actionscandidats'] = (boolean)Configure::read( 'Statistiqueplanpauvrete.actionscandidats' );
		...
		*
		*/
		private function _getConfigOrganismesplanpauvrete () {
