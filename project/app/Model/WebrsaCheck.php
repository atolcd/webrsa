<?php
	...
	class WebrsaCheck extends AppModel
	{
		...
		public $modelesParametrablesEnPlus = array(
			58 => array(
				'Commissionep/convocation_participant.odt',
				'Contratinsertion_contratinsertioncg58.odt',
				'Sanctionep58/decision_refuse.odt',
				'Sanctionep58/finsanction1.odt',
				'Sanctionep58/finsanction2.odt',
				'Sanctionep58/noninscritpe_courrierinformationavantep.odt',
				'Sanctionep58/radiepe_courrierinformationavantep.odt',
				'Sanctionrendezvousep58/courrierinformationavantep.odt',
			...
			66 => array(
				...
				'APRE/apre.odt',
				'APRE/etatliquidation.odt',
				'APRE/forfaitaire.odt',
				'Bilanparcours/bilanparcourspe_audition.odt',
				'Bilanparcours/bilanparcourspe.odt',
				'Bilanparcours/bilanparcourspe_parcours.odt',
				'Candidature/fichecandidatureeuro.odt',
				'Candidature/fichecandidature.odt',
				'Candidature/fichecandidatureregion.odt',
				'Candidature/fichecandidaturesante.odt',
				'Commissionep/convocationep_participant_facultatif.odt',
				'Commissionep/convocationep_participant_prioritaire.odt',
				'Commissionep/decisionep.odt',
				'Commissionep/fichesynthese.odt',
				'Commissionep/ordredujour_participant_audition.odt',
				'Commissionep/ordredujour_participant_parcours.odt',
				'Commissionep/pv_audition.odt',
				'Commissionep/pv_parcours.odt',
				'Contratinsertion/notifbenef.odt',
				'Contratinsertion/notifbenefParticuliernonvalideetudiant.odt',
				'Contratinsertion/notifbenefParticuliernonvalideradiation.odt',
				'Contratinsertion/notifbenefParticuliernonvaliderejet.odt',
				'Contratinsertion/notifbenefParticuliernonvalidereprise.odt',
				'Contratinsertion/PCG66/Traitementpcg66/EPD-02.odt',
				'Contratinsertion/PCG66/Traitementpcg66/Cible c.odt',
				'Contratinsertion/PCG66/Traitementpcg66/CISDemande CTRL OP.odt',
				'Contratinsertion/PCG66/Traitementpcg66/notifbenefParticuliernonvalideradiation.odt',
				'Contratinsertion/PCG66/Traitementpcg66/notifbenefParticuliernonvaliderejet.odt',
				'Contratinsertion/PCG66/Traitementpcg66/notifbenefParticuliernonvalidereprise.odt',
				'Contratinsertion/PCG66/Traitementpcg66/notifbenefParticuliervalide.odt',
				'Contratinsertion/PCG66/Traitementpcg66/notifbenefParticuliernonvalideradiation.odt',
				'Contratinsertion/PCG66/Traitementpcg66/PIECES 7 - Ressortissants européens - Nouvelle Ddde.odt',
				'Contratinsertion/PCG66/Traitementpcg66/Révision NSA Nouveau.odt',
				'CUI/2 info SF courrier NC info avant EPL.odt',
				'CUI/bilanparcours_courrierinformationavantep.odt',
				'CUI/decision_reorientation.odt',
				'CUI/Suite info SF courrier NR info avant EPL.odt',
				'Dossierep/decision_cg_annule.odt',
				'Dossierep/decision_cg_reporte.odt',
				'Orientation/notifications_cohorte.odt',
				'Orientation/notification_structure.odt',
				'Orientation/notif_orientation_cg66_mod2.odt',
				'Orientation/notification_structure.odt',
				'Orientation/proposition_orientation_vers_pole_emploi.odt',
				'Orientation/proposition_orientation_vers_SS_ou_PDV.odt',
				'Orientation/proposition_orientation_vers_SS_ou_PDV.odt',
				'PCG66/Traitementpcg66/EPD-02.odt',
				'PCG66/Traitementpcg66/ficheliaisoncerParticulier.odt',
				'PCG66/Traitementpcg66/notifbenefParticuliernonvalideradiation.odt',
				'PCG66/Traitementpcg66/notifbenefParticuliernonvaliderejet.odt',
				'PCG66/Traitementpcg66/notifbenefParticuliernonvalidereprise.odt',
				'PCG66/Traitementpcg66/notifbenefParticuliervalide.odt',
				'PCG66/Traitementpcg66/PIECES 7 - Ressortissants européens - Nouvelle Ddde.odt',
				'PCG66/Traitementpcg66/Révision NSA Nouveau.odt',
				'PDO/Courrierpdo/Cible domicilie.odt',
				'PDO/Courrierpdo/Cible generale.odt',
				'PDO/Courrierpdo/Cible heberge.odt',
				'PDO/Courrierpdo/Cible impot.odt',
				'PDO/Courrierpdo/Cible retraite.odt',
				'PDO/Courrierpdo/CIS-01.odt',
				'PDO/Courrierpdo/CIS-02.odt',
				'PDO/Courrierpdo/CIS-03.odt',
				'PDO/Courrierpdo/CIS-05.odt',
				'PDO/Courrierpdo/CIS-06.odt',
				'PDO/Courrierpdo/CIS-07.odt',
				'PDO/Courrierpdo/CIS-08.odt',
				'PDO/Courrierpdo/CIS-09.odt',
				'PDO/Courrierpdo/CIS-10.odt',
				'PDO/Courrierpdo/DEMANDE-01.odt',
				'PDO/Courrierpdo/DEMANDE-02.odt',
				'PDO/Courrierpdo/Demande CTRL OP.odt',
				'PDO/Courrierpdo/Demande rSaTI-RVtel-CIS.odt',
				'PDO/Courrierpdo/EPD-01.odt',
				'PDO/Courrierpdo/EPD-02.odt',
				'PDO/Courrierpdo/ficheliaisoncerParticulier.odt',
				'PDO/Courrierpdo/generique.odt',
				'PDO/Courrierpdo/INFO-01.odt',
				'PDO/Courrierpdo/INFO-02.odt',
				'PDO/Courrierpdo/INFO-03.odt',
				'PDO/Courrierpdo/INFO-04.odt',
				'PDO/Courrierpdo/INFO-05.odt',
				'PDO/Courrierpdo/INFO-06.odt',
				'PDO/Courrierpdo/INFO-07.odt',
				'PDO/Courrierpdo/INFO-08.odt',
				'PDO/Courrierpdo/INFO-09.odt',
				'PDO/Courrierpdo/INFO-10.odt',
				'PDO/Courrierpdo/INFO-11.odt',
				'PDO/Courrierpdo/INFO-12.odt',
				'PDO/Courrierpdo/INFO-13.odt',
				'PDO/Courrierpdo/Insertion 01.odt',
				'PDO/Courrierpdo/Insertion 02.odt',
				'PDO/Courrierpdo/Insertion 03.odt',
				'PDO/Courrierpdo/Insertion 04.odt',
				'PDO/Courrierpdo/Insertion 05.odt',
				'PDO/Courrierpdo/Insertion 06.odt',
				'PDO/Courrierpdo/Insertion 07.odt',
				'PDO/Courrierpdo/Insertion 08.odt',
				'PDO/Courrierpdo/Insertion 09.odt',
				'PDO/Courrierpdo/Insertion 10.odt',
				'PDO/Courrierpdo/Insertion 11.odt',
				'PDO/Courrierpdo/Insertion 12.odt',
				'PDO/Courrierpdo/Insertion 13.odt',
				'PDO/Courrierpdo/Insertion 14.odt',
				'PDO/Courrierpdo/Insertion 15.odt',
				'PDO/Courrierpdo/Insertion 16.odt',
				'PDO/Courrierpdo/Insertion 17.odt',
				'PDO/Courrierpdo/Insertion 18.odt',
				'PDO/Courrierpdo/Insertion 19.odt',
				'PDO/Courrierpdo/notifbenefParticuliernonvalideradiation.odt',
				'PDO/Courrierpdo/notifbenefParticuliernonvaliderejet.odt',
				'PDO/Courrierpdo/notifbenefParticuliernonvalidereprise.odt',
				'PDO/Courrierpdo/notifbenefParticuliervalide.odt',
				'PDO/Courrierpdo/PIECES 7 - Ressortissants européens - Nouvelle Ddde.odt',
				'RDV/01_Projet_convoc_rSa_4.odt',
				'Regressionorientationep/courrierinformationavantep.odt',
				'Saisinebilanparcoursep66/anc_decision_reorientation.odt',
				'Saisinebilanparcoursep66/courrierinformationavantep.odt',
				'Saisinepdoep66/courrierinformationavantep.odt',
				'Signalementep/courrierinformationavantep.odt',
			),
			93 => array(
				'APRE/accordaide.odt',
				'APRE/etatliquidation.odt',
				...
				'APRE/DecisionComite/Recours/recoursbeneficiaire.odt',
				'APRE/DecisionComite/Recours/recoursNonbeneficiaire.odt',
				'APRE/DecisionComite/Recours/recoursNonreferent.odt',
				'APRE/DecisionComite/Recours/recoursNontiers.odt',
				'APRE/DecisionComite/Recours/recoursOuibeneficiaire.odt',
				'APRE/DecisionComite/Recours/recoursOuireferent.odt',
				'APRE/DecisionComite/Recours/recoursOuitiers.odt',
				'APRE/DecisionComite/Recours/recourstiers.odt',
				'APRE/DecisionComite/Refus/Refustiers.odt',
				'APRE/Paiement/paiement_beneficiaire',
				'APRE/Paiement/refusaide.odt',
				'Candidature/fichecandidature.odt',
				'Commissionep/convocationep_beneficiaire_1er_passage.odt',
				'Commissionep/decisionep.odt',
				'Contratcomplexeep93/courrierinformationavantep.odt',
				'Contratcomplexeep93/decision_autre.odt',
				'Contratinsertion/ficheliaisoncerParticulier.odt',
				'Contratinsertion/ficheliaisoncerSimplemsp.odt',
				'Contratinsertion/ficheliaisoncerSimpleoa.odt',
				'Contratinsertion/notifbenefParticuliernonvalide.odt',
				'Contratinsertion/notifbenefParticuliervalide.odt',
				'Contratinsertion/notifbenefSimplenonvalide.odt',
				'Contratinsertion/notifbenefSimplevalide.odt',
				'Contratinsertion/notificationop.odt',
				'Dossierep/decision_cg_annule.odt',
				'Dossierep/decision_cg_reporte.odt',
				'Nonorientationproep/courrierinformationavantep.odt',
				'Nonrespectsanctionep93/orientstruct_courrierinformationavantep.odt',
				'Nonrespectsanctionep93/pdo_courrierinformationavantep.odt',
				'Nonrespectsanctionep93/radiepe_courrierinformationavantep.odt',
				'Orientation/aucun.odt',
				'Orientation/notifications_cohorte.odt',
				'Orientation/notification_structure.odt',
				'proposition_orientation_vers_pole_emploi_cohorte.odt',
				'proposition_orientation_vers_SS_ou_PDV_cohorte_avecimage.odt',
				'proposition_orientation_vers_SS_ou_PDV_cohorte.odt',
				'PDO/Courrierpdo/CIS_attestation_entretien.odt',
				'PDO/Courrierpdo/CIS_demande_TNS.odt',
				'PDO/Courrierpdo/Courrier_dissuasif_de_fausses_declarations.odt',
				'PDO/propositiondecision.odt',
				'RDV/modele_convoc_ci.odt',
				'RDV/modele_convoc_orient.odt',
				'RDV/modele_convoc_suivi.odt',
				'Regressionorientationep/courrierinformationavantepmodele_convoc_suivi.odt',
				'Relance/notifications_relances.odt',
				'Relancenonrespectsanctionep93/notification_orientstruct_relance3.odt',
				'Relancenonrespectsanctionep93/notification_pdo_relance1.odt',
				'Relancenonrespectsanctionep93/notification_pdo_relance2.odt',
				'Relancenonrespectsanctionep93/notification_radiepe_relance1.odt',
				'Relancenonrespectsanctionep93/notification_radiepe_relance2.odt',
				'Reorientationep93/courrierinformationavantep.odt',
				'Reorientationep93/decision_acceptepoleemploi.odt',
				'Reorientationep93/decision_autre.odt',
				'Seanceep/ordedujour.odt',
				'Signalementep93/courrierinformationavantep.odt',
				'Signalementep93/decision_autre.odt',
				'Transfertpdv93/transfert.odt',
				// 3.2.6
				'Bilanparcours/bilanparcours',
				'Bilanparcours/bilanparcourspe',
				'Bilanparcours/bilanparcourspe_audition.odt',
				'Bilanparcours/bilanparcourspe_parcours.odt',
				'APRE/Bilanparcours/courrierinformationapresep',
				'APRE/Bilanparcours/courrierinformationavantep',
				'Commissionep/ordredujour_participant_audition.odt',
				'Commissionep/ordredujour_participant_parcours.odt',
...
//$return = array( );
		...
		public function allControllersAcos() {
			...
			$cmd = 'sudo -u apache vendor/cakephp/cakephp/lib/Cake/Console/cake WebrsaSessionAcl update Aco -app app';
