<?php
	/**
	 * Code source de la classe WebrsaCohortePlanpauvreterendezvousInfocolVenuNonvenuSecondRdvNouveaux.
	 *
	 * PHP 7.2
	 *
	 * @package app.Model
	 ...
	 * @package app.Model
	 */
	class WebrsaCohortePlanpauvreterendezvousInfocolVenuNonvenuSecondRdvNouveaux extends WebrsaCohortePlanpauvreterendezvous
	{
		/**
		 * Nom du modèle.
		 *
		 * @var string
		 */
		public $name = 'WebrsaCohortePlanpauvreterendezvousInfocolVenuNonvenuSecondRdvNouveaux';
		...
		public function searchQuery( array $types = array() ) {
			...
			$query = $this->requeteParRendezvous ($query, 'cohorte_infocol_venu_nonvenu_second_rdv_nouveaux');
		...
		public function saveCohorte( array $data, array $params = array(), $user_id = null ) {
			$params['nom_cohorte'] = 'cohorte_infocol_venu_nonvenu_second_rdv_nouveaux';
			$success = parent::saveCohorte($data, $params, $user_id);

			if( $success && Configure::read( 'PlanPauvrete.Cohorte.OrientationrdvSocialeDeFait.enabled' ) == true ) {
