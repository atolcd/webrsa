<?php
	/**
	 * Code source de la classe WebrsaCohortePlanpauvreterendezvousInfocolVenuNonvenuSecondRdvStock.
	 *
	 * PHP 7.2
	 *
	 * @package app.Model
	 ...
	 * @package app.Model
	 */
	class WebrsaCohortePlanpauvreterendezvousInfocolVenuNonvenuSecondRdvStock extends WebrsaCohortePlanpauvreterendezvous
	{
		/**
		 * Nom du modèle.
		 *
		 * @var string
		 */
		public $name = 'WebrsaCohortePlanpauvreterendezvousInfocolVenuNonvenuSecondRdvStock';
		...
		public function searchQuery( array $types = array() ) {
			...
			$query = $this->requeteParRendezvous ($query, 'cohorte_infocol_venu_nonvenu_second_rdv_stock');
