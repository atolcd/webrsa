...
SELECT pg_catalog.setval('accoemplois_id_seq', 1, false);
...
SELECT pg_catalog.setval('difdisps_id_seq', 1, false);
...
SELECT pg_catalog.setval('diflogs_id_seq', 1, false);
...
SELECT pg_catalog.setval('difsocs_id_seq', 1, false);
...
SELECT pg_catalog.setval('nataccosocfams_id_seq', 1, false);
...
SELECT pg_catalog.setval('nataccosocindis_id_seq', 1, false);
...
SELECT pg_catalog.setval('natmobs_id_seq', 1, false);
...
SELECT pg_catalog.setval('nivetus_id_seq', 1, false);
...
SELECT pg_catalog.setval('servicesinstructeurs_id_seq', 1, false);
...
SELECT pg_catalog.setval('structuresreferentes_id_seq', 1, false);
...
SELECT pg_catalog.setval('typesactions_id_seq', 1, false);
...
SELECT pg_catalog.setval('typesorients_id_seq', 1, false);
...
SELECT pg_catalog.setval('typoscontrats_id_seq', 1, false);
...
SELECT pg_catalog.setval('zonesgeographiques_id_seq', 1, false);
