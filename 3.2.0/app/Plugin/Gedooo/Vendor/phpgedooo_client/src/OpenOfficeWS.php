...
class OpenOfficeWS
{
    ...
    public function generateDocument($sFormat)
    {
    ...
    public function convertDocument($sFormat)
    {
        // Attention: Non testé
    ...
    public function __construct(&$oEnv, $aParams = array())
    {
        $this->oEnv =& $oEnv;
     ...
     */
    public function process($sFormat = "pdf")
    {
    ...
    public function convert($sFormat = "pdf")
    {
