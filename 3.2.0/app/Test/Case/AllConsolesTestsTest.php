<?php
	 ...
	 * @package       app.Test.Case
	 */
	class AllConsolesTestsTest extends PHPUnit_Framework_TestSuite
	{
		/**
		...
		public static function suite() {
			$Suite = new CakeTestSuite('All Consoles');
			$filters = array('Console\/');
